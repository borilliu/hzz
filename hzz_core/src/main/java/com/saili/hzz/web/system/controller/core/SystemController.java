...
import com.saili.hzz.web.system.manager.ClientSort;
...
import com.saili.hzz.core.extend.hqlsearch.parse.ObjectParseUtil;
import com.saili.hzz.core.extend.hqlsearch.parse.PageValueConvertRuleEnum;
...
import com.saili.hzz.core.util.ListUtils;
import com.saili.hzz.core.util.MutiLangSqlCriteriaUtil;
import com.saili.hzz.core.util.MutiLangUtil;
import com.saili.hzz.core.util.PropertiesUtil;
...
import com.saili.hzz.core.util.UrlCheckUtil;
import com.saili.hzz.core.util.YouBianCodeUtil;
import com.saili.hzz.core.util.oConvertUtils;
import com.saili.hzz.web.system.pojo.base.Client;
import com.saili.hzz.web.system.pojo.base.DataLogDiff;
...
//		List<Object> types = this.systemService.findByQueryString(hql.toString());
	...
	public AjaxJson saveDepart(TSDepart depart, HttpServletRequest request) {
		...
		if (StringUtil.isNotEmpty(depart.getId())) {
			TSLDivisionEntity division = systemService.findUniqueByProperty(TSLDivisionEntity.class, "code", depart.getTSLDivision().getCode());
			depart.setTSLDivision(division);
...
//			depart.setOrgCode(orgCode);
    ...
    public AjaxJson ftpUploader(HttpServletRequest request, HttpServletResponse response) {
        ...
        PropertiesUtil ftpConfig = new PropertiesUtil("properties/sysConfig.properties");
