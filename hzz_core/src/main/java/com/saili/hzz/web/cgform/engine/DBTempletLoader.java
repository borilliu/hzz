package com.saili.hzz.web.cgform.engine;

import com.saili.hzz.web.cgform.common.CgAutoListConstant;
import com.saili.hzz.web.cgform.common.FormHtmlUtil;
...
import com.saili.hzz.web.cgform.service.cgformftl.CgformFtlServiceI;
...
public class DBTempletLoader implements TemplateLoader {
	...
	public static final String TEMPLET = "com/saili/hzz/web/cgform/engine/jform.ftl";
	public static final String TEMPLET_ONE_MANY = "com/saili/hzz/web/cgform/engine/jformunion.ftl";
	//生成输入框匹配内容
...
//	    		com.saili.hzz.core.util.LogUtil.info(content);
...
//				e.printStackTrace();
//			}
//			com.saili.hzz.core.util.LogUtil.info("current path :" + path);
//		}
