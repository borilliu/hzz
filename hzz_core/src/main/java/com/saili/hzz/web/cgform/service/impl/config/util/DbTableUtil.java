package com.saili.hzz.web.cgform.service.impl.config.util;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.saili.hzz.web.cgform.service.impl.config.*;
import com.saili.hzz.web.cgform.service.config.DbTableHandleI;
import com.saili.hzz.web.cgform.service.config.DbTableServiceI;
import com.saili.hzz.web.cgform.service.impl.config.DbTableMysqlHandleImpl;
import com.saili.hzz.web.cgform.service.impl.config.DbTableOracleHandleImpl;
import com.saili.hzz.web.cgform.service.impl.config.DbTablePostgresHandleImpl;
import com.saili.hzz.web.cgform.service.impl.config.DbTableServiceMysqlImpl;
import com.saili.hzz.web.cgform.service.impl.config.TableSQLServerHandleImpl;
...
//		return name;
	...
	public static DbTableHandleI getTableHandle(Session  session) {
		...
		else if (dialect.equals("com.saili.hzz.core.common.hibernate.dialect.MySQLServer2008Dialect")) {
			dbTableHandle = new TableSQLServerHandleImpl();
		}
