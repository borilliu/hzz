...
import com.saili.hzz.web.system.pojo.base.TSUserPositionRelEntity;
import com.saili.hzz.web.system.service.SystemService;
import com.saili.hzz.web.system.service.TSCompanyPositionServiceI;
...
public class TSCompanyPositionController extends BaseController {
	...
	public void datagrid(TSCompanyPositionEntity tSCompanyPosition, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		HqlGenerateUtil.installHql(cq, tSCompanyPosition, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
