...
public interface SystemService extends CommonService{
	...
	public static String UPDATE_BY_JSONOBJECT_TABLE="UPDATE_BY_JSONOBJECT_TABLE";
	public static String UPDATE_BY_JSONOBJECT_TABLE_TYPE="UPDATE_BY_JSONOBJECT_TABLE_TYPE";
