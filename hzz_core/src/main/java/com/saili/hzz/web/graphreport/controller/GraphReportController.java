package com.saili.hzz.web.graphreport.controller;
...
public class GraphReportController extends BaseController {
	...
	public void list(String id, HttpServletRequest request,
		...
		String html = viewEngine.parseTemplate("/com/saili/hzz/web/graphreport/engine/core/graphreportlist.ftl", cgReportMap);
