package com.saili.hzz.web.black.controller;
...
import com.saili.hzz.web.black.service.TsBlackListServiceI;
...
public class TsBlackListController extends BaseController {
	...
	public void datagrid(TsBlackListEntity tsBlackList, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		HqlGenerateUtil.installHql(cq, tsBlackList, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
