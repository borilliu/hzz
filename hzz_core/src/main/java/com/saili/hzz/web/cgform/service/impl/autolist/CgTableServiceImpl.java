package com.saili.hzz.web.cgform.service.impl.autolist;
...
public class CgTableServiceImpl extends CommonServiceImpl implements CgTableServiceI {
	...
	public boolean delete(String table, Object id) throws com.saili.hzz.web.cgform.exception.BusinessException {
//		try{
			...
			if(data!=null){
			    ...
			    while(it.hasNext()){
			        ...
			        //com.saili.hzz.core.util.LogUtil.info("name:"+ok.toString()+";value:"+ov.toString());
			    }
