package com.saili.hzz.web.cgform.common;

import org.apache.commons.lang.StringUtils;
import com.saili.hzz.core.util.StringUtil;
import com.saili.hzz.web.cgform.entity.config.CgFormFieldEntity;
import com.saili.hzz.web.cgform.service.impl.config.util.ExtendJsonConvert;
/**   
 * @author liuby
...
//    	html.append("<link rel=\"stylesheet\" href=\""+basePath+"/plug-in/uploadify/css/uploadify.css\" type=\"text/css\"></link>");
//    	html.append("<script type=\"text/javascript\" src=\""+basePath+"/plug-in/uploadify/jquery.uploadify-3.1.js\"></script>");

    	html.append("<table>");
    	html.append("<#list filesList as fileB>");
    	html.append("<tr style=\"height:34px;\">");
    	html.append("<td>\\${fileB['title']}</td>");
    	html.append("<td><a href=\"commonController.do?viewFile&fileid=\\${fileB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity\" title=\"下载\">下载</a></td>");
    	html.append("<td><a href=\"javascript:void(0);\" onclick=\"openwindow('预览','commonController.do?openViewFile&fileid=\\${fileB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity','fList',700,500)\">预览</a></td>");
