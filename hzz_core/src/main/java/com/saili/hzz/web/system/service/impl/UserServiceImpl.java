...
import com.saili.hzz.core.util.*;
import com.saili.hzz.web.system.dao.UserDao;
...
//			systemService.saveActivitiUser(user);
	...
	@Override
	public List<TSUser> selectByDivisionCode(String divisionCode) {
		return userDao.selectByDivisionCode(divisionCode);
	}
