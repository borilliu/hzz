package com.saili.hzz.web.cgdynamgraph.controller;
...
import com.saili.hzz.core.util.*;
import com.saili.hzz.web.cgdynamgraph.service.core.CgDynamGraphServiceI;
...
public class CgDynamGraphController extends BaseController {
	...
	public void design(String id, HttpServletRequest request,String gtype,
		...
		if(StringUtil.isEmpty(gtype)&&StringUtil.isEmpty(defaultGtype)){
			html = viewEngine.parseTemplate("/com/saili/hzz/web/cgdynamgraph/engine/core/cgDynamGraphDesign.ftl", cgDynamGraphMap);
		}
		//跳转到简单页面，只有查询条件与图
		else{
			...
			//设置gtype
			html = viewEngine.parseTemplate("/com/saili/hzz/web/cgdynamgraph/engine/core/cgDynamGraphDesignMobile.ftl", cgDynamGraphMap);
		}
