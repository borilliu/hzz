				...
				<div class="accordion-inner">
					<div class="panel panel-default" style="margin-bottom: 0px;">
			                ...
			                <form id="searchForm" class="form form-horizontal" action="" method="post">
								...
								<#if po.query==true>
									<#include "/com/saili/hzz/tag/core/factory/ftl/component/bootstrapTable-search.ftl">
								</#if>
								</#list>
	...
	var TableInit = function () {
	    ...
	    oTableInit.Init = function () {
	        $('#${dataGrid.name}').bootstrapTable({
				...
				<#list dataGrid.columnList as po>
				<#if po.field!="opt">
				 <#include "/com/saili/hzz/tag/core/factory/ftl/component/bootstrapTable-column.ftl">
				<#else>
				 ,{
	              title: "操作",align: 'center',valign: 'middle',width: ${po.width},
	              formatter: function (value, row, index) {
	                 <#include "/com/saili/hzz/tag/core/factory/ftl/component/bootstrapTable-opt.ftl">
	              }
	              }
				</#if>
				</#list>
