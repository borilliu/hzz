...
//			}
	...
	public int doEndTag() throws JspException {
		...
		if(StringUtil.isEmpty(lang)||"null".equals(lang)){
			lang="zh-cn";
		}
		JspWriter out = null;
		try {
...
//					sb.append("<link rel=\"stylesheet\" href=\""+basePath+"/plug-in/Validform/css/"+cssTheme+"/divfrom.css\" type=\"text/css\"/>");
//				}else{
...
//			if("metro".equals(cssTheme)){
//				sb.append("<link rel=\"stylesheet\" href=\""+basePath+"/plug-in/Validform/css/"+cssTheme+"/style.css\" type=\"text/css\"/>");
//				sb.append("<link rel=\"stylesheet\" href=\""+basePath+"/plug-in/Validform/css/"+cssTheme+"/tablefrom.css\" type=\"text/css\"/>");
//			}else{
...
//			}
			...
			if("6".equals(tiptype)){
				sb.append("<link rel=\"stylesheet\" href=\""+basePath+"/plug-in/Validform/css/tiptype.css\" type=\"text/css\"/>");
			...
			sb.append("<script src=\""+basePath+"/plug-in/layer/layer.js\"></script>");
...
//			sb.append("},");
	...
	private void submitLoading(StringBuffer sb) {
		...
		sb.append("infoTable.parent().append('<div id=\"infoTable-loading\" style=\"text-align:center;\"><img src=\""+basePath+"/plug-in/layer/skin/default/loading-0.gif\"/></div>');");
