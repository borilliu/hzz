...
import com.saili.hzz.web.superquery.util.SuperQueryUtil;
...
import com.saili.hzz.demo.entity.JformOrderCustomer2Entity;
import com.saili.hzz.demo.entity.JformOrderMain2Entity;
import com.saili.hzz.demo.entity.JformOrderTicket2Entity;
import com.saili.hzz.demo.page.JformOrderMain2Page;
import com.saili.hzz.demo.service.JformOrderMain2ServiceI;
...
public class JformOrderMain2Controller extends BaseController {
	...
	public ModelAndView index(HttpServletRequest request) {
		return new ModelAndView("demo/jformOrderMain2/jformOrderMain2Index");
	}
	/**
	 * 订单主信息列表 页面跳转
	 * 
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("demo/jformOrderMain2/main/list");
	}
	...
	public void datagrid(JformOrderMain2Entity jformOrderMain2,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		HqlGenerateUtil.installHql(cq, jformOrderMain2);
		try{
			//自定义追加查询条件
	...
	public ModelAndView goAdd(HttpServletRequest req) {
		//跳转主页面
		return new ModelAndView("demo/jformOrderMain2/main/addOrUpdate");
	}
	...
	public ModelAndView mainPage(JformOrderMain2Entity jformOrderMain2, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jformOrderMain2/main/jformOrderMain2");
	}
	...
	public ModelAndView jformOrderTicket2List(JformOrderMain2Entity jformOrderMain2, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jformOrderMain2/main/jformOrderTicket2");
	}
	/**
	 * 加载明细列表[订单客户信息]
	 * 
	...
	public ModelAndView jformOrderCustomer2List(JformOrderMain2Entity jformOrderMain2, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jformOrderMain2/main/jformOrderCustomer2");
	}
