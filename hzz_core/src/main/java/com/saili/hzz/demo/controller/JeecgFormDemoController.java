...
import com.saili.hzz.core.enums.StoreUploadFilePathEnum;
import com.saili.hzz.core.extend.hqlsearch.HqlGenerateUtil;
import com.saili.hzz.core.util.DateUtils;
import com.saili.hzz.core.util.HttpRequest;
import com.saili.hzz.core.util.JSONHelper;
import com.saili.hzz.core.util.MutiLangUtil;
import com.saili.hzz.core.util.MyClassLoader;
import com.saili.hzz.core.util.NumberComparator;
...
import com.saili.hzz.demo.entity.TSDocument;
...
public class JeecgFormDemoController extends BaseController {
	...
	public ModelAndView uitag(HttpServletRequest request) {
		return new ModelAndView("demo/form_uitag");
	}
	...
	public ModelAndView popupMultiValue(HttpServletRequest request) {
		...
		return new ModelAndView("demo/form_popupMultiValue");
	}
	...
	public ModelAndView eSignDemo(HttpServletRequest request) {
		return new ModelAndView("demo/zsign");
	}
	...
	public ModelAndView siteSelect(HttpServletRequest request) {
		...
		return new ModelAndView("demo/siteSelect");
	}	
	...
	public ModelAndView rowListDemo(HttpServletRequest request) {
		...
		return new ModelAndView("demo/specialLayout");
	}
	...
	public ModelAndView function(ModelMap model) {
		return new ModelAndView("demo/functionList");
	}
	...
	public ModelAndView selectSort() {
		return new ModelAndView("demo/form_selectSort");
	}
	...
	public ModelAndView gridSelectdemo() {
		return new ModelAndView("demo/gridSelectdemo");
	}
	...
	public ModelAndView ztreeDemo(HttpServletRequest request) {
		return new ModelAndView("demo/ztreeDemo");
	}
	...
	public ModelAndView interfaceTestDemo(HttpServletRequest request) {
		...
		return new ModelAndView("demo/form_interfaceTestDemo");
	}
	...
	public ModelAndView webuploader(HttpServletRequest request) {
		...
		return new ModelAndView("demo/form_webuploader");
	}
	...
	public ModelAndView dropDownDatagrid(HttpServletRequest request) {
		return new ModelAndView("demo/dropDownDatagrid");
	}
	...
	public ModelAndView bootstrapTreeListDemo(ModelMap model) {
		return new ModelAndView("demo/bootstrapTreeList");
	}
	/**
	 * bootstrap树形列表获取数据
	 * 
	...
	public ModelAndView plupload(HttpServletRequest request) {
		return new ModelAndView("demo/plupload/plupload1");
	}
	@RequestMapping(params = "plupload2")
	public ModelAndView plupload3(HttpServletRequest request) {
		return new ModelAndView("demo/plupload/plupload3");
	}
	...
	public ModelAndView goPlupload(HttpServletRequest request) {
		...
		return new ModelAndView("demo/plupload/plupload5");
	}
	/**
	 * 文件分割 请求处理
	...
	public ModelAndView printingDemo(ModelMap model) {
		return new ModelAndView("demo/printingDemo");
	}
	...
	public ModelAndView multiSelect() {
		return new ModelAndView("demo/select_multi");
	}
}