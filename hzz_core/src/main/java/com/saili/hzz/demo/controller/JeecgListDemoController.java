package com.saili.hzz.demo.controller;
...
import com.saili.hzz.core.beanvalidator.BeanValidators;
...
import com.saili.hzz.core.common.model.json.Highchart;
...
import com.saili.hzz.core.util.JeecgDataAutorUtils;
...
import com.saili.hzz.jwt.util.GsonUtil;
...
import com.saili.hzz.web.system.util.InterfaceUtil;
...
import com.saili.hzz.demo.dao.JeecgMinidaoDao;
import com.saili.hzz.demo.entity.JeecgDemoEntity;
import com.saili.hzz.demo.entity.JeecgDemoPage;
import com.saili.hzz.demo.entity.JeecgLogReport;
import com.saili.hzz.demo.service.JeecgDemoServiceI;
...
public class JeecgListDemoController extends BaseController {
	...
	public ModelAndView minidaoListDemo(HttpServletRequest request) {
		return new ModelAndView("demo/taglist_minidao");
	}
	...
	public ModelAndView rowListDemo(HttpServletRequest request) {
		return new ModelAndView("demo/list_rowedtior");
	}
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("demo/jeecgDemoList");
	}
	...
	public ModelAndView multiHeaList(HttpServletRequest request) {
		return new ModelAndView("demo/jeecgDemoList-multihead");
	}
	...
	public ModelAndView mysearchListDemo(HttpServletRequest request) {
		return new ModelAndView("demo/taglist_mysearch");
	}
	...
	public ModelAndView mysearchListDemo2(HttpServletRequest request) {
		return new ModelAndView("demo/taglist_mysearch2");
	}
	...
	public ModelAndView broswerStatisticTabs(HttpServletRequest request) {
		return new ModelAndView("demo/reportDemo");
	}
	...
	public ModelAndView querysBuilder(HttpServletRequest request) {
		return new ModelAndView("demo/querysBuilderDemo");
	}
	...
	public ModelAndView goFormQuerysBuilder(HttpServletRequest request) {
		return new ModelAndView("demo/form_querysBuilder");
	}
	...
	public ModelAndView InstrumenDtiagram(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/InstrumentDiagram");
	}
	/**
	 * 日程图
	 * @param request
	...
	public ModelAndView Schedule(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/Schedule");
	}
	 /**
	  * 柱状图1
	  * @param request
	...
	public ModelAndView BarGraph1(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/BarGraph1");
	}	
	/**
	  * 柱状图2
	  * @param request
	...
	public ModelAndView BarGraph2(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/BarGraph2");
	}	
	/**
	  * 柱状图3
	  * @param request
	...
	public ModelAndView BarGraph3(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/BarGraph3");
	}
	/**
	  * 柱状图4
	  * @param request
	...
	public ModelAndView BarGraph4(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/BarGraph4");
	}
	/**
	  * 漏斗图1
	  * @param request
	...
	public ModelAndView funnelPlot1(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/funnelPlot1");
	}
	/**
	  * 漏斗图2
	  * @param request
	...
	public ModelAndView funnelPlot2(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/funnelPlot2");
	}
	/**
	  * 折线图1
	  * @param request
	...
	public ModelAndView lineChart1(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/lineChart1");
	}
	/**
	  * 折线图2
	  * @param request
	...
	public ModelAndView lineChart2(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/lineChart2");
	}
	/**
	  * 折线图3
	  * @param request
	...
	public ModelAndView lineChart3(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/lineChart3");
	}/**
	  * 折线图4
	  * @param request
	  * @return
	...
	public ModelAndView lineChart4(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/lineChart4");
	}/**
	  * 折线图5
	  * @param request
	  * @return
	...
	public ModelAndView lineChart5(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/lineChart5");
	}
	/**
	  * 饼图1
	  * @param request
	...
	public ModelAndView PieChart1(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/PieChart1");
	}
	/**
	  * 饼图2
	  * @param request
	...
	public ModelAndView PieChart2(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/PieChart2");
	}
	/**
	  * 点状图1
	  * @param request
	...
	public ModelAndView PointChart1(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/PointChart1");
	}
	/**
	  * 点状图2
	  * @param request
	...
	public ModelAndView PointChart2(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/PointChart2");
	}
	/**
	  * 点状图3
	  * @param request
	...
	public ModelAndView PointChart3(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/PointChart3");
	}
	/**
	  * 矩形图
	  * @param request
	...
	public ModelAndView RectangularGraph(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/RectangularGraph");
	}
	/**
	  * 其他1
	  * @param request
	...
	public ModelAndView other1(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/other1");
	}
	...
	public ModelAndView TotalReport(HttpServletRequest request) {
		return new ModelAndView("demo/echartsDemo/TotalReport");
	}
	/**
	  * 综合报表
	  * @param request
...
//		dataGrid.setFooter("salary,age,name:合计");
	...
	public ModelAndView addTab(HttpServletRequest request) {
		...
		return new ModelAndView("demo/demoTab");
	...
	public ModelAndView goCheck( HttpServletRequest request) {
		...
		return new ModelAndView("demo/jeecgDemo-check");
	...
	public ModelAndView goBuilderDemo( HttpServletRequest request) {
		return new ModelAndView("demo/superQueryDemo");
	...
	public ModelAndView addWithbtn(HttpServletRequest request) {
		return new ModelAndView("demo/jeecgDemo-add-btn");
	...
	public ModelAndView print(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jeecgDemo-print");
	}
	...
	public ModelAndView goAdd(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jeecgDemo-add");
	}
	/**
	 * jeecg_demo编辑页面跳转
	 * 
	...
	public ModelAndView goUpdate(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jeecgDemo-update");
	}
	...
	public ModelAndView log() {
		return new ModelAndView("demo/logList");
	}
	...
	public ModelAndView goOnlyData(HttpServletRequest req,JeecgLogReport log) {
		return new ModelAndView("demo/logrp-onlyData");
	}
	...
	public ModelAndView goChart(HttpServletRequest req,JeecgLogReport log) {
		...
		return new ModelAndView("demo/logrp-chart");
	}
	...
	public ModelAndView echartDemo(HttpServletRequest req) {
		return new ModelAndView("demo/echartsDemo");
	}
	...
	public ResponseMessage<Map<String,Object>> list(@RequestParam("pageNo") int pageNo, @RequestParam("pageSize") int pageSize,JeecgDemoEntity entity,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		HqlGenerateUtil.installHql(query, entity, request.getParameterMap());
	...
	public ModelAndView bootTableDemo(HttpServletRequest request) {
		return new ModelAndView("demo/jeecgDemo-bootstrap-list");
	}
	...
	public ModelAndView goBootStrapTableUpdate(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jeecgDemo-bootstrap-update");
	}
	...
	public ModelAndView goBootStrapTableAdd(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
		...
		return new ModelAndView("demo/jeecgDemo-bootstrap-add");
	}
		...
		public ModelAndView natureAceTableDemo(HttpServletRequest request) {
			return new ModelAndView("demo/jeecgDemo-nature-ace-list");
		}
		...
		public ModelAndView goNatureAceTableUpdate(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
			...
			return new ModelAndView("demo/jeecgDemo-nature-ace-update");
		}
		...
		public ModelAndView goNatureAceTableAdd(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
			...
			return new ModelAndView("demo/jeecgDemo-nature-ace-add");
		}
		...
		public ModelAndView bootstrapTableTagDemo(HttpServletRequest request) {
			return new ModelAndView("demo/jeecgDemo-bootstrap-list-tag");
		}
		...
		public ModelAndView bootstrapTableTagDemo2(HttpServletRequest request) {
			return new ModelAndView("demo/jeecgDemo-bootstrap-list-tag2");
		}
		...
		public ModelAndView goBootStrapTableUpdate2(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
			...
			return new ModelAndView("demo/jeecgDemo-bootstrap-update2");
		}
		...
		public ModelAndView goBootStrapTableAdd2(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
			...
			return new ModelAndView("demo/jeecgDemo-bootstrap-add2");
		}
		...
		public ModelAndView bootStrapEchartsDemo(HttpServletRequest request) {
			return new ModelAndView("demo/echartsDemo/bootstrap-echarts");
		}
		...
		public ModelAndView collapseDemo() {
			return new ModelAndView("demo/jeecgDemoList-collapse");
		}
		...
		public ModelAndView suggest(HttpServletRequest request) {
			return new ModelAndView("demo/suggest");
		}
		...
		public ModelAndView goDraggablePanels(HttpServletRequest request) {
			return new ModelAndView("demo/draggablePanels");
		}
