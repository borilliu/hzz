...
import com.saili.hzz.core.util.JxlsExcelExportUtil;
...
import com.saili.hzz.demo.util.FreemarkerUtil;
...
public class JeecgDemoExcelController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("demo/excel/jeecgDemoExcelList");
	}
	/**
	 * easyui AJAX请求数据
	 * 
	...
	public void datagrid(JeecgDemoExcelEntity jeecgDemoExcel,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		HqlGenerateUtil.installHql(cq, jeecgDemoExcel, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
	...
	public ModelAndView goAdd(JeecgDemoExcelEntity jeecgDemoExcel, HttpServletRequest req) {
		...
		return new ModelAndView("demo/excel/jeecgDemoExcel-add");
	}
	/**
	 * excel导入导出测试表编辑页面跳转
	 * 
	...
	public ModelAndView goUpdate(JeecgDemoExcelEntity jeecgDemoExcel, HttpServletRequest req) {
		...
		return new ModelAndView("demo/excel/jeecgDemoExcel-update");
	}
