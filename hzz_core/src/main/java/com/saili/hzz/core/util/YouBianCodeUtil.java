...
//			 com.saili.hzz.core.util.LogUtil.info(after_code);
//			 com.saili.hzz.core.util.LogUtil.info(after_code_zimu);
//			 com.saili.hzz.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// com.saili.hzz.core.util.LogUtil.info(getNextZiMu('C'));
		// com.saili.hzz.core.util.LogUtil.info(getNextNum(8));
		LogUtil.info(getSubYouBianCode("C99A01","B03"));
//		com.saili.hzz.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
