package com.saili.hzz.core.common.service.impl;
...
import com.saili.hzz.tag.vo.easyui.Autocomplete;
...
public class CommonServiceImpl implements CommonService {
	...
	public <T> List<T> findByPropertyisOrder(Class<T> entityClass,
		...
		return commonDao.findByPropertyisOrder(entityClass, propertyName,value,orderPropertyName, orderIsAsc);
	}
