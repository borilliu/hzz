 ...
 * @author  liuby
 */
public class TestBaseUser extends IdEntity implements java.io.Serializable {
...
//	}
	...
	private TSLUserTypeEntity TSLUserTypeEntity; //用户类型
	/**
	 * 方法: 取得TSLUserTypeEntity
	 * 
	 * @return: TSLUserTypeEntity 上级code
	 */
	public TSLUserTypeEntity getTSLUserTypeEntity() {
		return this.TSLUserTypeEntity;
	}
	 ...
	 */
	public void setTSLUserTypeEntity(TSLUserTypeEntity TSLUserTypeEntity) {
		this.TSLUserTypeEntity = TSLUserTypeEntity;
	}
