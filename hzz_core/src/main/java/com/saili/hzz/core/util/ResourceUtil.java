package com.saili.hzz.core.util;
...
import com.saili.hzz.core.constant.DataBaseConstant;
...
//	public static Map<String, List<TSType>> allTypes = new HashMap<String,List<TSType>>();
	...
	public static JSONObject getCacheTypesByDictionary(String dictionary,String typecode,JSONObject jsonObject){
		...
		if (typeList != null && !typeList.isEmpty()) {
			for (TSType type : typeList) {
				if (type.getTypecode().equals(typecode)){
	                ...
	                jo.put("typecode",type.getTypecode());
	                jo.put("typename",type.getTypename());
	                jsonObject.put(dictionary.toLowerCase(), jo);
					break;
				}
			}
		}
...
//	public static Map<String, DynamicDataSourceEntity> dynamicDataSourceMap = new HashMap<String, DynamicDataSourceEntity>();
	...
	private static final ResourceBundle bundle = java.util.ResourceBundle.getBundle("properties.sysConfig");
