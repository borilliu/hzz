package com.saili.hzz.core.interceptors;
...
import com.saili.hzz.core.annotation.JAuth;
import com.saili.hzz.core.constant.Globals;
import org.apache.log4j.Logger;
import com.saili.hzz.core.common.model.json.AjaxJson;
import com.saili.hzz.core.enums.Permission;
import com.saili.hzz.core.extend.hqlsearch.SysContextSqlConvert;
...
public class AuthInterceptor implements HandlerInterceptor {
	...
	private void forwardTimeOut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.sendRedirect(request.getSession().getServletContext().getContextPath()+"/views/login/timeout.jsp");
	}
