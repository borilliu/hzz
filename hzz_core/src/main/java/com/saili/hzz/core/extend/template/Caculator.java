package com.saili.hzz.core.extend.template;
...
//					{
//						com.saili.hzz.core.util.LogUtil.info(tt);
//					}
...
//        com.saili.hzz.core.util.LogUtil.info(calc.transInfixToPosfix("1+2*3+7.5-(4/2+8)/5"));
//        com.saili.hzz.core.util.LogUtil.info("value is:"+calc.calc());
        
//        com.saili.hzz.core.util.LogUtil.info(calc.transInfixToPosfix("110815.00047*2"));
//        com.saili.hzz.core.util.LogUtil.info("value is:"+calc.calc());
//        com.saili.hzz.core.util.LogUtil.info(calc.transInfixToPosfix("110815.125047*2"));
//        com.saili.hzz.core.util.LogUtil.info("value is:"+calc.calc());
        
//        com.saili.hzz.core.util.LogUtil.info(calc.transInfixToPosfix("((110815.0347)*2+10)/0"));
//        com.saili.hzz.core.util.LogUtil.info("value is:"+calc.calc());
        
        
//        com.saili.hzz.core.util.LogUtil.info(calc.transInfixToPosfix("0.02"));
//        com.saili.hzz.core.util.LogUtil.info("value is:"+calc.calc());
//        com.saili.hzz.core.util.LogUtil.info(calc.transInfixToPosfix("0.0"));
//        com.saili.hzz.core.util.LogUtil.info("value is:"+calc.calc());
