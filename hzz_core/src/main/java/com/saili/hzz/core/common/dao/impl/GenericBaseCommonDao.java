...
import com.saili.hzz.core.annotation.JeecgEntityTitle;
import com.saili.hzz.core.util.*;
import com.saili.hzz.tag.vo.datatable.DataTableReturn;
...
import com.saili.hzz.core.common.hibernate.qbc.HqlQuery;
import com.saili.hzz.core.common.hibernate.qbc.PageList;
import com.saili.hzz.core.common.hibernate.qbc.PagerUtil;
import com.saili.hzz.core.common.model.common.DBTable;
import com.saili.hzz.core.util.MyBeanUtils;
import com.saili.hzz.core.util.StringUtil;
import com.saili.hzz.core.util.ToEntityUtil;
...
//		}
	 ...
	 * @return
	 */
	private <T> Criteria createCriteria(Class<T> entityClass, String orderPropertyName,boolean orderIsAsc,
	...
	public <T> List<T> findByPropertyisOrder(Class<T> entityClass,
			String propertyName, Object value, String orderPropertyName,boolean orderIsAsc) {
		Assert.hasText(propertyName);
		return createCriteria(entityClass, orderPropertyName,orderIsAsc,
				Restrictions.eq(propertyName, value)).list();
	}
