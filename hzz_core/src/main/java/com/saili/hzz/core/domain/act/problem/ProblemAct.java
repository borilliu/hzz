 ...
 */
package com.saili.hzz.core.domain.act.problem;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.saili.hzz.core.common.entity.IdEntity;
import com.saili.hzz.core.util.TimeUtils;
import com.saili.hzz.core.util.Variable;
 ...
 * @version 2013-11-03
 */
public class ProblemAct extends IdEntity implements java.io.Serializable {
	...
	public String getTaskDefKey() {
		if (StringUtils.isEmpty(taskDefKey) && task != null){
	...
	public String getStatus() {
	    String tempTaskDefKey = getTaskDefKey();
        if (null == getAssignee()) {
            return "待签收";
        }
        if (null != tempTaskDefKey && "end".equals(tempTaskDefKey)) {
            return "已办结";
        }
        if (null != tempTaskDefKey && tempTaskDefKey.endsWith("Audit")) {
            return "待派遣";
        }
        if (null != tempTaskDefKey && tempTaskDefKey.endsWith("River")) {
            return "处理中";
        }
		return status;
	}
	...
	public List<ProblemAct> getList() {
		return list;
	}

	public void setList(List<ProblemAct> list) {
		this.list = list;
	}
	...
	public String getProcDefKey() {
		if (StringUtils.isBlank(procDefKey) && StringUtils.isNotBlank(getProcDefId())){
			procDefKey = StringUtils.split(getProcDefId(), ":")[0];
		}
		return procDefKey;
	}
	...
	public String getTaskExecutionId() {
		if (taskExecutionId == null && task != null) {
