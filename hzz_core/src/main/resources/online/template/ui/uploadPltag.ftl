	...
	<div id = "${po.field_name}thelist" class="uploader-list">
		...
		<#if fileB['field']?lower_case == po.field_name>
			<tr class="upload_generate history" style="">
				...
				<td>
					<a title="预览" href="javascript:void(0);" onclick="openwindow('预览','${basePath}/commonController.do?openViewFile&fileid=${fileB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity','fList',700,500)" style="margin:0 8px;">预览</a>
				</td>
				<td>
					<a title="下载" href="${basePath}/commonController.do?viewFile&fileid=${fileB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity" style="margin:0 8px;">下载</a>
				</td>
			</tr>
		</#if>
		</#list>
