 ...
 <#if po.show_type=='file'>
	<table>
		...
		<#list filesList as fileB>
			...
			<td><a style="margin-left:8px;" href="${basePath}/commonController.do?viewFile&fileid=${fileB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity" title="下载">下载</a></td>
			<td><a style="margin-left:8px;"  href="javascript:void(0);" onclick="openwindow('预览','${basePath}/commonController.do?openViewFile&fileid=${fileB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity','fList',700,500)">预览</a></td>
	...
	<#elseif po.show_type=='image'>
		<table>
			...
			<#list imageList as imageB>
				...
				<#-- update--begin--author:zhangjiaqiang date:20170608 for:增加下载、预览、删除按钮之间的间隔 -->
				<td><a style="margin-left:8px;"  href="${basePath}/commonController.do?viewFile&fileid=${imageB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity" title="下载">下载</a></td>
				<td><a style="margin-left:8px;"  href="javascript:void(0);" onclick="openwindow('预览','${basePath}/commonController.do?openViewFile&fileid=${imageB['fileKey']}&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity','fList',700,500)">预览</a></td>
