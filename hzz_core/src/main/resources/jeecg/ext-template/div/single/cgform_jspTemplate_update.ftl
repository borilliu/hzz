	  		   ...
	  		   success: function(data){
	  			...
	  			$.each(arrayFileObj,function(n,file){
	  				...
	  				var td_title = $("<td title=\""+file.title+"\">" + title + "</td>");
	  		  		var td_download = $("<td style=\"width:40px;text-align: center;\"><a href=\"commonController.do?viewFile&fileid=" + file.fileKey + "&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity\" title=\"下载\">下载</a></td>")
	  		  		var td_view = $("<td style=\"width:40px;text-align: center;\"><a href=\"javascript:void(0);\" onclick=\"openwindow('预览','commonController.do?openViewFile&fileid=" + file.fileKey + "&subclassname=com.saili.hzz.web.cgform.entity.upload.CgUploadEntity','fList',700,500)\">预览</a></td>");
