...
(function () {
    ...
    function I(G, _) {
        ...
        function E(F, E) {
            F.innerHTML = "<iframe id='datePickerFrame' hideFocus=true width=97 height=9 frameborder=0 border=0 scrolling=no></iframe>";
            ...
            G.push("<script>var t;t=t||setInterval(function(){if(document.ready){window.ym97dp =new My97DP();$cfg.onload();$c.autoSize();$cfg.setPos($dp);clearInterval(t);}},20);if($FF||$OPERA)document.close();</script>");
            E.setPos = B;
            E.onload = Y;
            D.write("<html>");
            D.cfg = E;
