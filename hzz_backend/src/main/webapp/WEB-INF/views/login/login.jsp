<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page
	import="com.saili.hzz.core.util.SysThemesUtil,com.saili.hzz.core.enums.SysThemesEnum"%>
					...
					<div class="login-container">
						<div class="center">
							<h1 id="id-text2" class="grey">
								<i class="ace-icon fa fa-leaf green"></i> 河长制湖长制工作管理信息系统
							</h1>
							<h4 class="blue" id="id-company-text-title">江苏赛立</h4>
						</div>
										...
										<div class="widget-main">
											...
											<label class="block clearfix"> <span
												class="block input-icon input-icon-right"> <input
													...
													value="demo" /> <i class="ace-icon fa fa-user"></i>
											</span>
											...
											<div class="clearfix">
												...
												<a href="loginController.do?goResetPwdMail"
