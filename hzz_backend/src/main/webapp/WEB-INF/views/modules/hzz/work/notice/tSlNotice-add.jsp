...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSlNoticeController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="docNo" name="docNo" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="openProcedure" name="openProcedure" type="text" maxlength="100" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="publishDate" name="publishDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore" />    
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="height:auto;width:95%" class="inputxt" rows="6" id="contentDescribe" name="contentDescribe"  datatype="*" ignore="checked" ></textarea>
							<span class="Validform_checktip"></span>
