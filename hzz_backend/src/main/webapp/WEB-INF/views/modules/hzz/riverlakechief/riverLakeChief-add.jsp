...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="riverLakeChiefController.do?doAdd">
    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value">
                <input id="user" name="account.userName" type="text" maxlength="32" style="width: 150px" class="inputxt"
                       datatype="*" ajaxurl="riverLakeChiefController/checkAccount.do"
                />
        ...
        <tr>
            ...
            <td class="value">
                <input id="depart" name="depart.id" type="text" readonly="readonly" class="inputxt" <%--datatype="*"--%>/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="duty" name="duty" type="text" maxlength="32" style="width: 150px" class="inputxt" ignore="ignore"/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="phone" name="phone" type="text" maxlength="32" style="width: 150px" class="inputxt"
                       ignore="ignore"/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="email" name="email" type="email" maxlength="32" style="width: 150px" class="inputxt"
                       ignore="ignore"/>
                <span class="Validform_checktip"></span>
