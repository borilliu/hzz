...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="waitHandleList" checkbox="false" pagination="true" fitColumns="true" title="流程管理"
                    actionUrl="/riverLakePatrolController/problemList.do" idField="taskId" fit="true"
                    queryMode="group">
            ...
            <t:dgFunOpt exp="assignee#empty#false" title="交办" urlclass="ace_button" urlfont="fa-edit"
                        funname="szqm1(taskId,taskName,taskDefKey,procInsId,procDefId,status,'procDef.name')"></t:dgFunOpt>
            <t:dgOpenOpt exp="assignee#empty#false" title="交办" urlclass="ace_button" urlfont="fa-edit" width="700"
                         height="600"
                         url="riverLakePatrolController/form.do?taskId={taskId}&taskName={taskName}&taskDefKey={taskDefKey}&procInsId={procInsId}&procDefId={procDefId}&status={status}"></t:dgOpenOpt>
...
<script type="text/javascript">
    function szqm1(taskId, taskName, taskDefKey, procInsId, procDefId, status, procDefName) {
        debugger
        console.log(procDefName);
