...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid checkbox="false" name="entityList" title="公众投诉管理"
			...
			<t:dgFunOpt title="审核" exp="eventStatus#eq#21" urlclass="ace_button"
				urlfont="fa-edit" funname="szqm(id)"></t:dgFunOpt>
			...
			<t:dgFunOpt title="反馈" exp="eventStatus#eq#24" urlclass="ace_button"
				urlfont="fa-edit" funname="szqm3(id)"></t:dgFunOpt>
