...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="workReportController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="title" name="title" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${workReportPage.title}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="batch" name="batch" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${workReportPage.batch}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="publishDate" name="publishDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*"  ignore="checked" value='<fmt:formatDate value='${workReportPage.publishDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="publishSources" name="publishSources" type="text" maxlength="100" style="width: 150px" class="inputxt"  ignore="ignore"  value='${workReportPage.publishSources}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="publishOrgCode" name="publishOrgCode" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${workReportPage.publishOrgCode}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="publishOrgName" name="publishOrgName" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${workReportPage.publishOrgName}'/>
							<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
				...
				function accessoryOnUploadStart(file){
					...
					<tr>
						...
						<td class="value" >
                                ...
                                <textarea name="publishContent" id="publishContent" style="width: 650px;height:300px">${workReportPage.publishContent }</textarea>
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="remarks" style="height:auto;width:95%;" class="inputxt" rows="6" name="remarks"  ignore="ignore" >${workReportPage.remarks}</textarea>
							<span class="Validform_checktip"></span>
	  	...
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "workReportController.do?getFiles&id=" +  cgFormId,
