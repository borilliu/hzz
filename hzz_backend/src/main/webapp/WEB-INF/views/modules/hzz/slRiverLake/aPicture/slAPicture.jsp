...
<link rel="stylesheet" href="plug-in/leaflet/leaflet.css" />
<script src="plug-in/leaflet/leaflet.js"></script>


<script src="plug-in/leaflet/leaflet.ChineseTmsProviders.js"></script>
<script src="plug-in/leaflet/GPS_conversion.js"></script>
...
<body style="overflow-y: hidden" scroll="no">
     ...
     * 智图地图内容
     */
    var geoq_normalm01 = L.tileLayer.chinaProvider('Geoq.Normal.Map', {
        maxZoom: 18,
        minZoom: 5
    });
	
    var geoq_normalm02 = L.tileLayer.chinaProvider('Geoq.Normal.Color', {
        maxZoom: 18,
        minZoom: 5
    });
	
    var geoq_normalm03 = L.tileLayer.chinaProvider('Geoq.Normal.PurplishBlue', {
        maxZoom: 18,
        minZoom: 5
    });
    var geoq_normalm04 = L.tileLayer.chinaProvider('Geoq.Normal.Gray', {
        maxZoom: 18,
        minZoom: 5
    });
    var geoq_normalm05 = L.tileLayer.chinaProvider('Geoq.Normal.Warm', {
        maxZoom: 18,
        minZoom: 5
    });
	
    var geoq_normalm06 = L.tileLayer.chinaProvider('Geoq.Normal.Cold', {
        maxZoom: 18,
        minZoom: 5
    });
    /**
     * 天地图内容
     */
    var tiandi_normalm01 = L.tileLayer.chinaProvider('TianDiTu.Normal.Map', {
	    maxZoom: 18,
	    minZoom: 5
	});
	var tiandi_normalm02 = L.tileLayer.chinaProvider('TianDiTu.Normal.Annotion', {
	    maxZoom: 18,
	    minZoom: 5
	});
	var tiandi_normalm03 = L.tileLayer.chinaProvider('TianDiTu.Satellite.Map', {
	    maxZoom: 18,
	    minZoom: 5
	});
	var tiandi_normalm04 = L.tileLayer.chinaProvider('TianDiTu.Satellite.Annotion', {
	    maxZoom: 18,
	    minZoom: 5
	});
    var tiandi_normalm05 = L.layerGroup([tiandi_normalm01, tiandi_normalm02]);
    var tiandi_normalm06 = L.layerGroup([tiandi_normalm03, tiandi_normalm04]);
    /**
     * 谷歌
     */
    var google_normalm01 = L.tileLayer.chinaProvider('Google.Normal.Map', {
        maxZoom: 18,
        minZoom: 5
    });
    var google_normalm02 = L.tileLayer.chinaProvider('Google.Satellite.Map', {
        maxZoom: 18,
        minZoom: 5
    });
    /**
     * 高德地图
     */
    var gaode_normalm01 = L.tileLayer.chinaProvider('GaoDe.Normal.Map', {
        maxZoom: 18,
        minZoom: 5
    });
    var gaode_normalm02 = L.tileLayer.chinaProvider('GaoDe.Satellite.Map', {
        maxZoom: 18,
        minZoom: 5
    });
    var gaode_normalm03 = L.tileLayer.chinaProvider('GaoDe.Satellite.Annotion', {
        maxZoom: 18,
        minZoom: 5
    });
    var gaode_normalm04 = L.layerGroup([gaode_normalm02, gaode_normalm03]);

    var baidu_normalm01 = L.tileLayer.chinaProvider('BaiDu.Custom.Map', {
        maxZoom: 18,
        minZoom: 5
    });
    
    var osm_normalm01 = L.tileLayer.chinaProvider('OSM.Normal.Map', {
        maxZoom: 18,
        minZoom: 5,
    });
  ...
  var testData = {
	...
	var baseLayers = {
			"智图地图": geoq_normalm01,
	        //"智图多彩": geoq_normalm02,  
			"智图午夜蓝": geoq_normalm03,
			"智图灰色": geoq_normalm04,
			"智图暖色": geoq_normalm05,
	        //"智图冷色": geoq_normalm06,
			"天地图": tiandi_normalm05,
			"天地图影像": tiandi_normalm06,
			"谷歌地图": google_normalm01,
			"谷歌影像": google_normalm02,
			"高德地图": gaode_normalm01,
			"高德影像": gaode_normalm02,
			"高德亮图": gaode_normalm03,
			//"百度地图": baidu_normalm01,
			"osm地图": osm_normalm01,
		}
...
$(document).ready(function(){
	...
	$('#dd').combotree({
		url : 'loginController.do?setPFunction&selfId=${depart.id}',
        width: 155,
	...
	jQuery.ajax({  
		type: 'POST',  
		dataType : "json",  
		url: 'loginController.do?getAPictureInfo',
...
//				bd09togcj06=117.18970708714448,34.25537876602132
				...
				var options1={
				  ...
				  zoom: 11,
				  layers: [geoq_normalm01, heatmapLayer],
				  zoomControl: false,
