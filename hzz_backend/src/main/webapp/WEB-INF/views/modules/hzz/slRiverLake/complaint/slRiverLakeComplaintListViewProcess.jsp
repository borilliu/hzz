		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="handleName"
					name="handleName" ignore="ignore" value="${entity.handleName}">
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="handlePhone"
					name="handlePhone" ignore="ignore" value="${entity.handlePhone}">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">
				...
				<td class="value"><input class="inputxt" id="handleDept"
					name="handleDept" ignore="ignore" value="${entity.handleDept}">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"
				...
				<td class="value"><input type="text" class="Wdate"
					...
					style="width: 150px" id="handleDate" name="handleDate"
					value="<fmt:formatDate value='${entity.handleDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>">
			...
			<tr>
				...
				<td class="value"><t:dictSelect id="handleIsTF"
						...
						defaultVal="${entity.handleIsTF==null?'10':(entity.handleIsTF)}"
			...
			<tr>
				...
				<td class="value"><t:dictSelect id="handleType"
						...
						defaultVal="${entity.handleType==null?'10':(entity.handleType)}"
						datatype="*"></t:dictSelect> <span class="Validform_checktip"></span>
				</td>
			</tr>
			<tr>
				...
				<td class="value"><textarea rows="4" cols="15"
						class="inputxtarea" id="handleMemo" name="handleMemo"
						ignore="ignore" style="margin: 0px; height: 150px; width: 260px;">${entity.handleMemo} </textarea><span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">
						办结用时(天):</label></td>
				<td class="value"><input class="inputxt" id="finishedDay"
					name="finishedDay" ignore="ignore" value="${entity.finishedDay}">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">
						处理用时(小时):</label></td>
				<td class="value"><input class="inputxt" id="handleHour"
					name="handleHour" ignore="ignore" value="${entity.handleHour}">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"
				...
				<td class="value"><input type="text" class="Wdate"
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
					style="width: 150px" id="returnDate" name="returnDate"
					value="<fmt:formatDate value='${entity.returnDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>">
					<span class="Validform_checktip"></span> <label
			...
			<tr>
				<td align="right"><label class="Validform_label">
						群众满意度:</label></td>
				<td class="value"><t:dictSelect id="massSatisP"
						field="massSatisP" typeGroupCode="massSatisP" hasLabel="false"
						defaultVal="${entity.massSatisP==null?'10':(entity.massSatisP)}"
						datatype="*"></t:dictSelect> <span class="Validform_checktip"></span>
				</td>
			</tr>
