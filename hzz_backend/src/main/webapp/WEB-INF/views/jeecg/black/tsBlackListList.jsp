...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tsBlackListList" checkbox="false" pagination="true"
			fitColumns="false" title="黑名单"
			actionUrl="tsBlackListController.do?datagrid" idField="id" fit="true"
			queryMode="group" queryBuilder="true">
			...
			<t:dgCol title="ip地址" field="ip" queryMode="single" query="true"
				width="120"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="100"></t:dgCol>
			<t:dgDelOpt title="删除" url="tsBlackListController.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="tsBlackListController.do?goAdd" funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="tsBlackListController.do?goUpdate" funname="update"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove"
				url="tsBlackListController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search"
				url="tsBlackListController.do?goUpdate" funname="detail"></t:dgToolBar>
