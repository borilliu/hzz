...
<link rel="stylesheet" href="plug-in/ztree/css/metroStyle.css"
	type="text/css" />
	...
	<div class="easyui-layout" fit="true">
				...
				<div style="float: left; top: 1px">
					<ul id="dsUL">
						...
						<li id="dsLI" name="dsLI" class="conditions oop" data-index="0">
							<span> <input id="citySel" name="cons[0].tree"
								onclick="treeClick(this)" type="text" style="width: 120px;"
								class=" queryTree" readonly="readonly" /> &nbsp; <input
								id="tableVal" name="cons[0].hidd" type="hidden" value="" /> <input
								name="cons[0].tableCode" type="hidden" value="" />
						</span> <span> <select id="field" name="cons[0].fld"
								...
								<input id="conValue" name="cons[0].val" type="text"
								style="width: 165px;" class="text conditionValue" title="">
		...
		<div data-options="region:'south',border:false"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'icon-search'"
				href="javascript:void(0)" onclick="javascript:mySearch()">查询</a> <a
				class="easyui-linkbutton" data-options="iconCls:'icon-reload'"
				href="javascript:void(0)" onclick="searchReset()">重置</a> <a
				class="easyui-linkbutton" data-options="iconCls:'icon-save'"
				href="javascript:void(0)" onclick="saveBySelect()">另存为查询方案</a>
		</div>
		...
		<div id="menuContent" class="menuContent"
			style="display: none; position: absolute; background: #FFF; overflow: hidden; height: 120px; border: 0px">
			<ul id="orgTree" class="ztree"
				style="margin-top: -7px; width: auto; height: 100px;"></ul>
		</div>
		<input type="hidden" name="treeValue" value="" id="treeValue" /> <input
			type="hidden" name="selectValue" value="" id="selectValue" /> <input
			type="hidden" name="queryCode" value="${queryCode}" id="queryCode" />
		...
		<ul id="dsUL_template" style="display: none">
			<li class="conditions oop" data-index="#index#"><span> <input
			...
			</span> <span> <select id="condition" name="cons[#index#].ctyp"
					class="compareType" style="width: 150px">
						<option>&nbsp;</option>
						<option value="=">等于</option>
						<option value="!=">不等于</option>
					...
					<input id="conValue1" name="cons[#index#].val"
					style="width: 165px;" type="text" class="text conditionValue"
					title="">
			</span> <span> <a id="add" href="javascript:addULChild()"
					class="fa fa-plus-square" title="添加一个新的过滤条件"
					style="margin-left: 3px;"></a> <a id="delete"
