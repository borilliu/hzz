		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value"><select id="jformType" disabled="disabled"
					name="jformType">
						...
						<option value="2"
							<c:if test="${cgFormHeadPage.jformType eq '2'}"> selected="selected"</c:if>>一对多</option>
				</select></td>
			</tr>
			<tr>
				...
				<td class="value" colspan="3"><input disabled="disabled"
					...
					<div style="display: inline-block">
						<span>树形列表: </span> <input disabled type="radio"
							...
							value="0" />否
					</div> <!-- update-end-author:taoyan date:20180628 for:布局修改 --></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right"><label class="Validform_label">
						包名(小写): </label></td>
				<td class="value" colspan="3"><input class="inputxt"
					id="entityPackage" name="entityPackage" datatype="*"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">
				...
				<td class="value" colspan="3"><input class="inputxt"
					...
					value="${entityNames[cgFormHeadPage.tableName]}" datatype="*">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">
						需要生成的代码: </label></td>
				<td class="value" colspan="3"><input type="checkbox" value="1"
					name="actionFlag" id="actionFlag" checked="checked">Action</input>
					<input type="checkbox" value="1" name="jspFlag" id="jspFlag"
					checked="checked">Jsp</input> <input type="checkbox" value="1"
					name="serviceIFlag" id="serviceIFlag" checked="checked">ServiceI</input>
					<input type="checkbox" value="1" name="serviceImplFlag"
					id="serviceImplFlag" checked="checked">ServiceImpl</input> <input
					type="checkbox" value="1" name="pageFlag" id="pageFlag"
					checked="checked">Page</input> <input type="checkbox" value="1"
					name="entityFlag" id="entityFlag" checked="checked">Entity</input>
					<span class="Validform_checktip"></span> <!-- update-begin-author:taoyan date:20180628 for:布局修改 -->
					<div style="display: inline-block">
						<span>【</span> <span>是否支持Restful:</span> <input type="radio"
							name="supportRestful" value="1" />是 <input type="radio"
							name="supportRestful" checked="checked" value="0" />否 <span>】</span>
					</div> <!-- update-end-author:taoyan date:20180628 for:布局修改 --></td>
			</tr>
			...
			<tr>
				...
				<td class="value" colspan="3"><input type="radio"
					name="version" checked="checked" value="ext">老版本模板(IE8+/不支持移动/标签列表)
			...
			<tr id="jspMode_tr">
				...
				<td class="value" colspan="3"><select id="jspMode"
					name="jspMode" style="width: 220px" datatype="*">
