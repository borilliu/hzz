...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value"><select id="jformType" disabled="disabled"
					name="jformType">
						...
						<option value="2"
							<c:if test="${cgFormHeadPage.jformType eq '2'}"> selected="selected"</c:if>>一对多/一对一</option>
				</select></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> 主表名:
				</label></td>
				<td class="value" colspan="3"><input disabled="disabled"
					class="inputxt" id="tableName_tmp" name="tableName_tmp"
					value="${cgFormHeadPage.tableName}" datatype="*"> <span
					class="Validform_checktip"></span> <!-- update-begin-author:taoyan date:20180628 for:布局修改 -->
					<div style="display: inline-block">
						<span>树形列表: </span> <input disabled type="radio"
							name="supportTree"
							<c:if test="${cgFormHeadPage.isTree eq 'Y'}">checked="checked"</c:if>
							value="1" />是 <input disabled type="radio" name="supportTree"
							<c:if test="${cgFormHeadPage.isTree eq 'N'}">checked="checked"</c:if>
							value="0" />否
					</div></td>
			...
			<tr>
				<td align="right"><label class="Validform_label">
						主表实体名(首字母大写): </label></td>
				<td class="value"><input class="inputxt" id="entityName"
					name="entityName" datatype="*"
					value="${entityNames[cgFormHeadPage.tableName]}"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> 功能说明:
				</label></td>
				<td class="value" colspan="3"><input class="inputxt"
					id="ftlDescription" name="ftlDescription"
					value="${cgFormHeadPage.content}" datatype="*"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">主包名(小写):
				</label></td>
				<td class="value"><input class="inputxt" id="entityPackage"
					name="entityPackage" datatype="*"> <span
					class="Validform_checktip"></span></td>
			</tr>
			...
			<tr>
				...
				<td class="value" colspan="3"><input type="radio"
					name="version" datatype="*" checked="checked" value="ext">老版本模板(IE8+/不支持移动/标签列表)
			...
			<tr>
				<td align="right"><label class="Validform_label">
						是否支持Restful: </label></td>
				<td class="value" colspan="3"><input type="radio"
					name="supportRestful" value="1" />是 <input type="radio"
					name="supportRestful" checked="checked" value="0" />否</td>
			</tr>
			<!-- update--end--author:taoyan date:20180619 for:TASK #2812 【代码生成器优化】Restful swggerUI 代码生成，可选择 -->
			<tr>
				<td align="right"><label class="Validform_label"> 页面风格:
				</label></td>
				<td class="value"><select id="jspMode" name="jspMode"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<c:forEach items="${subTableList}" var="column"
				varStatus="columIndex">
				<tr>
					<td align="right">子表名:</td>
					<td class="value" colspan="3"><input readonly="readonly"
						class="inputxt" id="subTabParamIn[${columIndex.index}].tableName"
						name="subTabParamIn[${columIndex.index}].tableName"
						value="${column.tableName}" datatype="*"> <span
						class="Validform_checktip"></span></td>

					<td align="right">子表实体(首字母大写):</td>
					<td class="value" colspan="3"><input class="inputxt"
						id="subTabParamIn[${columIndex.index}].entityName"
						name="subTabParamIn[${columIndex.index}].entityName"
						value="${entityNames[column.tableName]}" datatype="*"> <span
						class="Validform_checktip"></span></td>

					<td align="right">功能说明:</td>
					<td class="value" colspan="3"><input class="inputxt"
						id="subTabParamIn[${columIndex.index}].ftlDescription"
						name="subTabParamIn[${columIndex.index}].ftlDescription"
						datatype="*"> <span class="Validform_checktip"></span></td>

					<td align="right">子包名(小写):</td>
					<td class="value" colspan="3"><input class="inputxt"
						id="subTabParamIn[${columIndex.index}].entityPackage"
						name="subTabParamIn[${columIndex.index}].entityPackage"
						datatype="*"> <span class="Validform_checktip"></span></td>
