...
<div class="easyui-layout" fit="true">
	...
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid sortName="createDate" sortOrder="desc"
			name="tablePropertyList" title="smart.form.config" fitColumns="true"
			...
			<t:dgCol title="table.type" field="jformType"
				replace="single.table_1,master.table_2,slave.table_3" query="true"
				width="60"></t:dgCol>
			<t:dgCol title="table.name" field="tableName" query="true"
				autocomplete="true" width="150" />
			<t:dgCol title="form.category" field="jformCategory"
				dictionary="bdfl" width="80"></t:dgCol>
			...
			<t:dgCol title="is.tree" field="isTree" hidden="true"
				replace="common.yes_Y,common.no_N" width="60"></t:dgCol>
	...
	--%>
			...
			<t:dgToolBar title="create.form" icon="fa fa-plus" width="100%"
				height="100%" url="cgFormHeadController.do?addorupdate"
				funname="addForm"></t:dgToolBar>
			<t:dgToolBar title="edit.form" icon="fa fa-edit" width="100%"
				height="100%" url="cgFormHeadController.do?addorupdate"
				funname="updateForm"></t:dgToolBar>
			<t:dgToolBar title="custom.button" icon="fa fa-bars"
				url="cgformButtonController.do?cgformButton" funname="cgFormButton"></t:dgToolBar>
			<t:dgToolBar title="js.enhance" icon="fa fa-strikethrough"
				url="cgformEnhanceJsController.do?addorupdate" funname="enhanceJs"></t:dgToolBar>
			<t:dgToolBar title="sql.enhance" icon="fa fa-filter"
				url="cgformButtonSqlController.do?addorupdate"
				operationCode="sql_enhance" funname="cgFormButtonSql"></t:dgToolBar>
			<t:dgToolBar title="java.enhance" icon="fa fa-wrench"
				url="cgformEnhanceJavaController.do?addorupdate"
				funname="javaEnhance"></t:dgToolBar>
			<t:dgToolBar title="form.export" icon="fa fa-download"
				url="cgformSqlController.do?doMigrateOut" funname="doMigrateOut"></t:dgToolBar>
			<t:dgToolBar title="form.import" operationCode="form_import"
				icon="fa fa-upload" url="cgformSqlController.do?inSqlFile"
				funname="toCgformMigrate"></t:dgToolBar>
			<t:dgToolBar title="code.generate" operationCode="code_generate"
				icon="fa fa-spinner" url="generateController.do?gogenerate"
				funname="generate"></t:dgToolBar>
			<t:dgToolBar title="form.generate" icon="fa fa-database"
