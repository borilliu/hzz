			...
			<table style="width: 100%; height: 100%" cellpadding="0"
			  ...
			  <tr>
				...
				<tr>
					...
					<td class="value" style="padding-top: 1em"><input
						type="hidden" id="templatePic" name="templatePic"
						value="${cgformTemplatePage.templatePic}" /> <t:upload
							queueID="hiddenArea" auto="true" dialog="false" outhtml="false"
							onUploadSuccess="viewPicUploadSuccess" id="templatePic_u"
							uploader="cgformTemplateController.do?uploadPic&sessionId=${pageContext.session.id}"
							extend="pic" name="templatePic_u"></t:upload>
						<div id="hiddenArea" style="display: none"></div></td>
				</tr>
				...
				<tr>
					...
					<td class="value"><t:upload id="templateZip"
							onFilesRemoved="zipFilesRemoved" onFileAdded="zipFileAdded"
							queueID="filediv" dialog="false" outhtml="false"
							onUploadSuccess="zipUploadSuccess" buttonText="浏览文件"
							multi="false" name="templateZip"
							uploader="cgformTemplateController.do?uploadZip&sessionId=${pageContext.session.id}"
							extend="*.zip;*.rar"></t:upload>
						<div class="form" id="filediv"></div> <span
						class="Validform_checktip"></span> <label class="Validform_label"
						style="display: none;">表单风格模板</label> <input type="hidden"
						id="templateZipName" name="templateZipName"
						value="${cgformTemplatePage.templateZipName}" /></td>
...
<script src="views/jeecg/cgform/template/cgformTemplate.js"></script>
<script>
