...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tSFillRuleList" checkbox="false" pagination="true"
			fitColumns="true" title="填值规则表"
			actionUrl="tSFillRuleController.do?datagrid" idField="id" fit="true"
			queryMode="group">
			...
			<t:dgCol title="规则code" field="ruleCode" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="规则名称" field="ruleName" queryMode="single" width="120"></t:dgCol>
			<t:dgCol title="规则实现类" field="ruleClass" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="规则参数" field="ruleParam" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="100"></t:dgCol>
			<t:dgDelOpt title="删除" url="tSFillRuleController.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="tSFillRuleController.do?goAdd" funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="tSFillRuleController.do?goUpdate" funname="update"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove"
				url="tSFillRuleController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search"
				url="tSFillRuleController.do?goUpdate" funname="detail"></t:dgToolBar>
