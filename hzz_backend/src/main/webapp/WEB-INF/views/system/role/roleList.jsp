...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="roleList" title="common.role.list"
			actionUrl="roleController.do?roleGrid" fitColumns="true" idField="id"
			sortName="id" sortOrder="desc" queryMode="group" btnCls="bootstrap">
			<t:dgCol title="common.code" field="id" hidden="true"></t:dgCol>
			<t:dgCol title="common.role.code" field="roleCode" width="200"></t:dgCol>
			<t:dgCol title="common.role.name" field="roleName" query="true"
				width="200"></t:dgCol>
			...
			<t:dgToolBar title="common.add.param" langArg="common.role"
				icon="fa fa-plus" url="roleController.do?addorupdate" funname="add"></t:dgToolBar>
			<t:dgToolBar title="common.edit.param" langArg="common.role"
				icon="fa fa-edit" url="roleController.do?addorupdate"
				funname="update"></t:dgToolBar>
			<t:dgToolBar title="excelImport" icon="fa fa-arrow-circle-left"
				funname="ImportXls"></t:dgToolBar>
			<t:dgToolBar title="excelOutput" icon="fa fa-arrow-circle-right"
				funname="ExportXls"></t:dgToolBar>
			<t:dgToolBar title="templateDownload"
				icon="fa fa-arrow-circle-o-down" funname="ExportXlsByT"></t:dgToolBar>
