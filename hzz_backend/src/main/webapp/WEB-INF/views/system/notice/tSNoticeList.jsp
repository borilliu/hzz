...
<div id="main_depart_list" class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<t:datagrid name="tSNoticeList" checkbox="true" fitColumns="true"
			title="内容管理" actionUrl="noticeController.do?datagrid2" idField="id"
			fit="true" queryMode="group">
			<t:dgCol title="ID" field="id" hidden="true" queryMode="group"
				width="120"></t:dgCol>
			<t:dgCol title="通知编号" field="noticeCode" hidden="false"
			...
			<t:dgCol title="通知公告类型" sortable="false" field="noticeType"
				dictionary="noticeType" query="false" width="100"></t:dgCol>
			...
			<t:dgToolBar title="common.add" icon="icon-add"
				url="noticeController.do?goAdd" funname="add"></t:dgToolBar>
			<t:dgToolBar title="common.edit" icon="icon-edit"
				url="noticeController.do?goUpdate" funname="update"></t:dgToolBar>
