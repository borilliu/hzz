...
<div class="easyui-layout" style="width: 800px; height: 400px;">
	<div data-options="region:'east',split:true" title="用户选择"
		style="width: 200px;">
		<table class="table-list" border="1" bordercolor="#e5e5e5"
	...
	<div data-options="region:'center'">
		...
		<t:datagrid checkbox="false" name="userList1"
			...
			actionUrl="departAuthGroupController.do?getUserDataGrid&groupId=${groupId}"
			...
			<t:dgCol title="common.username" width="150" sortable="false"
				field="userName" query="true"></t:dgCol>
			<t:dgCol title="common.real.name" width="150" field="realName"
				query="true"></t:dgCol>
		</t:datagrid>
	</div>
</div>
