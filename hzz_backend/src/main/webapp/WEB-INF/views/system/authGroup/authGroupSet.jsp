		...
		<table class="table-form" cellspacing="0">
			<tbody>
				<tr>
					...
					<td class="ng-binding"><input type="text" name="groupName"
						id="groupName" value="${departAuthGroup.groupName }" /></td>
				</tr>

				<c:set var="curId" value="${departAuthGroup.id}"></c:set>
				<tr>
					<th><span>部门名称:</span></th>
					<td class="ng-binding"><input id="deptId" name="deptId"
						type="hidden" value="${departAuthGroup.deptId}"> <input
						id="deptName" name="deptName" type="text"
						value="${departAuthGroup.deptName}"
						<c:if test="${not empty curId}">onclick="javascript:void(0)" readonly="readonly"</c:if>
						onclick="openDepartmentSelect()"></td>
				</tr>
				<tr style="display: none">
					<th><span>部门编码:</span></th>
					<td class="ng-binding"><input type="hidden"
						value="${departAuthGroup.departType}" id="departType"
						name="departType"> <input type="text" name="deptCode"
						id="deptCode" value="${departAuthGroup.deptCode }" /></td>
				</tr>
			</tbody>
		</table>
	</t:formvalid>
