...
<body>
	...
	<div class="easyui-layout" fit="true" scroll="no">
		<div data-options="region:'west',title:'部门管理员组设置',split:true"
			style="width: 254px; overflow: auto;">
			<a <c:if test="${userName ne 'admin'}">style="display:none;"</c:if>
				icon="icon-add" class="easyui-linkbutton l-btn l-btn-plain"
				onclick="addOneNode()"> <span class="bigger-110 no-text-shadow">添加管理员组</span>
			</a> <br /> <input style="width: 120px;" type="text" id="supplier"
