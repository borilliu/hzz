...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="fList" title="文件下载"
			actionUrl="jeecgFormDemoController.do?documentList&typecode=files"
			...
			<t:dgCol title="创建时间" field="createdate"
				formatter="yyyy-MM-dd hh:mm:ss" width="20"></t:dgCol>
			...
			<t:dgDefOpt
				...
				urlclass="ace_button" urlfont="fa-trash-o" title="下载"></t:dgDefOpt>
			<t:dgOpenOpt width="700" height="600"
				url="commonController.do?openViewFile&fileid={id}&subclassname={subclassname}"
				urlclass="ace_button" urlfont="fa-trash-o" title="预览"></t:dgOpenOpt>
			<t:dgDelOpt url="jeecgFormDemoController.do?delDocument&id={id}"
				title="删除" urlclass="ace_button" urlfont="fa-trash-o"></t:dgDelOpt>
			<t:dgToolBar title="文件录入" icon="icon-add" funname="add"
				url="jeecgFormDemoController.do?addFiles"></t:dgToolBar>
			...
			<t:dgToolBar title="编辑" icon="icon-edit" funname="update"
				url="jeecgFormDemoController.do?editFiles"></t:dgToolBar>
		</t:datagrid>
