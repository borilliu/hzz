...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="userController.do?saveInterfaceUser">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1"
			...
			<c:if test="${!empty roleId }">
				<tr>
					<td align="right" width="25%" nowrap><label
						class="Validform_label"> 所属接口角色: </label></td>
					<td class="value" width="85%">${roleName}</td>
				</tr>
			</c:if>
			<tr>
			...
			<c:if test="${empty user.id}">
				...
				<tr>
					...
					<td class="value"><input id="repassword" class="inputxt"
						type="password" value="" recheck="password" datatype="*6-18"
