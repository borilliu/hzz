...
<script>
	 ...
	 */
		...
		$(function(){
			...
			//console.log("1212");
			$('#dd').combotree({
				url : 'slDivisionController.do?divisionTree&selfId=${depart.id}',
	            width: 155,
...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
				...
				<td class="value" width="85%"><c:if test="${user.id!=null }"> ${user.userName } </c:if>
					<c:if test="${user.id==null }">
						<input id="userName" class="inputxt" name="userName"
							...
							maxlength="50" datatype="s2-50" />
						<span class="Validform_checktip"> <t:mutiLang
								langKey="username.rang2to50" /></span>
					</c:if></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label"> 用户职务: </label></td>
				<td class="value" width="10%"><input id="userDutys"
					class="inputxt" name="userDutys" value="${user.userDutys }"
					maxlength="25" datatype="s2-100" /> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label"> 排位顺序: </label></td>
				<td class="value" width="10%"><input id="userOrderBy"
					class="inputxt" name="userOrderBy" value="${user.userOrderBy }"
					maxlength="25" /> <span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				...
				<td class="value"><input id="dd"
					...
					value="${user.TSLDivision.code}"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right" nowrap><label class="Validform_label">
						用户类型: </label></td>
				<td class="value"><input id="pId" name="TSLUserTypeEntity.id"
					type="hidden" value="${user.TSLUserTypeEntity.id}"> <input
					id="ee" value="${user.TSLUserTypeEntity.name}"> <input
					id="eeId" name="TSLUserTypeEntity.code" style="display: none;"
					value="${user.TSLUserTypeEntity.code}"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<c:if test="${user.id==null }">
				<tr>
			...
			<tr>
				...
				<td class="value"><input id="departname" name="departname"
					type="text" readonly="readonly" class="inputxt" datatype="*"
					...
					class="Validform_checktip"><t:mutiLang
							langKey="please.muti.department" /></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> <t:mutiLang
							langKey="common.role" />:
			...
			<tr>
				...
				<td class="value"><input class="inputxt" name="email"
					value="${user.email}" validType="t_s_user,email,id" datatype="e"
					errormsg="邮箱格式不正确!" /> <span class="Validform_checktip"></span></td>
			</tr>
			<tr style="display: none">
				<td align="right"><label class="Validform_label"> <t:mutiLang
							langKey="common.common.dev" />:
				</label></td>
				<td class="value"><t:dictSelect id="devFlag" field="devFlag"
						typeGroupCode="dev_flag" hasLabel="false"
						defaultVal="${user.devFlag==null?'0':(user.devFlag)}" type="radio"></t:dictSelect>
