...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1"
				...
				<td class="value" width="85%"><c:if test="${user.id!=null }"> ${user.userName } </c:if>
					<c:if test="${user.id==null }">
						...
						<span class="Validform_checktip"> <t:mutiLang
								langKey="username.rang2to18" /></span>
					</c:if></td>
			</tr>
			<tr>
				<td align="right" width="25%" nowrap><label
					class="Validform_label"> 所属组织机构: </label></td>
				<td class="value" width="85%">${departname}</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label">英文名: </label></td>
				<td class="value" width="10%"><input id="userNameEn"
					class="inputxt" name="userNameEn" value="${user.userNameEn }" /> <span
					class="Validform_checktip">填写英文名</span></td>
			</tr>
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label">工号: </label></td>
				<td class="value" width="10%"><input id="empNo" class="inputxt"
					name="empNo" value="${user.empNo }" /> <span
					class="Validform_checktip">填写工号</span></td>
			</tr>
			<%-- <tr>
			...
			<tr>
				...
				<td class="value"><t:dictSelect id="sex" field="sex"
						typeGroupCode="sex" hasLabel="false" defaultVal="${user.sex}"
						type="radio"></t:dictSelect> <span class="Validform_checktip"></span>
				</td>
			</tr>
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label">身份证号: </label></td>
				<td class="value" width="10%"><input id="citizenNo"
					class="inputxt" name="citizenNo" value="${user.citizenNo }" /> <span
					class="Validform_checktip">填写身份证号</span></td>
			</tr>
			<c:if test="${user.id==null }">
				<tr>
			...
			<tr>
				...
				<td class="value">
					<!-- validType="t_s_user,email,id" --> <input class="inputxt"
					name="email" value="${user.email}" datatype="e" errormsg="邮箱格式不正确!" />
					<span class="Validform_checktip"></span>
				</td>
			</tr>
			<tr>
				...
				<td class="value" width="10%"><input id="fax" class="inputxt"
					name="fax" value="${user.fax }" /> <span
					class="Validform_checktip">填写传真</span></td>
			</tr>
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label">联系地址: </label></td>
				<td class="value" width="10%"><input id="address"
					class="inputxt" name="address" value="${user.address}" /> <span
					class="Validform_checktip">填写联系地址</span></td>
			</tr>
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label">邮编: </label></td>
				<td class="value" width="10%"><input id="post" class="inputxt"
					name="post" value="${user.post}" /> <span
					class="Validform_checktip">填写邮编</span></td>
			</tr>
			<tr>
				<td align="right" width="10%" nowrap><label
					class="Validform_label">备注: </label></td>
				<td class="value" width="10%"><textarea id="memo" name="memo"
						rows="5" cols="80">${user.memo}</textarea> <span
					class="Validform_checktip">填写备注</span></td>
			</tr>
			<%-- <tr>
