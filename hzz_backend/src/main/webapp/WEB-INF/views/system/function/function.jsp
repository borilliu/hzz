...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" layout="div" dialog="true"
		callback="@Override callbackTreeLoad" refresh="true"
		...
		<fieldset class="step">
			...
			<div class="form">
				<label class="Validform_label"> <t:mutiLang
					...
					<option value="1"
						<c:if test="${function.functionType>0}"> selected="selected"</c:if>>
			...
			<div class="form" id="pfun">
				<label class="Validform_label"> <t:mutiLang
						langKey="parent.function" />:
				</label> <input id="cc"
					<c:if test="${function.TSFunction.functionLevel eq 0}"> value="${function.TSFunction.id}"</c:if>
			...
			<div class="form" id="funurl">
				<label class="Validform_label"> <t:mutiLang
						langKey="menu.url" />:
				</label> <input name="functionUrl" class="inputxt"
					value="${function.functionUrl}" style="width: 70%">
			</div>
			...
			<div class="form" id="funorder">
				<label class="Validform_label"> <t:mutiLang
						langKey="menu.order" />:
				</label> <input name="functionOrder" class="inputxt"
					value="${function.functionOrder}" datatype="n1-3">
			</div>
			<div class="form" id="funiconstyle">
				<label class="Validform_label"> <t:mutiLang
						langKey="menu.funiconstyle" />:
				</label> <input name="functionIconStyle" class="inputxt"
					value="${function.functionIconStyle}" />
				<%-- <a href="<%=basePath%>/views/common/functionIconStyleList.jsp?style=ace"  target="_blank">[ace图标样式]</a>--%>
				<a href="http://fontawesome.dashgame.com" target="_blank"> <i
					class="fa fa-eye-slash"></i>选择图标库
				</a>
			</div>
		</fieldset>
	</t:formvalid>
