...
<t:datagrid name="operationList" title="接口权限规则"
	actionUrl="interfaceController.do?ruledatagrid&interfaceId=${interfaceId}"
	idField="id">
	...
	<t:dgDelOpt url="interfaceController.do?delrule&id={id}"
	...
	<t:dgToolBar title="common.add.param" langArg="common.operation"
		icon="icon-add"
		url="interfaceController.do?addorupdaterule&interfaceId=${interfaceId}"
