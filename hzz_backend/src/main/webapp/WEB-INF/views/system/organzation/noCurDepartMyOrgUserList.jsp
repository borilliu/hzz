...
<div id="main_depart_list" class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="noCurDepartUserList" title="common.operation"
			actionUrl="organzationController.do?addMyOrgUserToOrgList&orgId=${orgId}"
...
<div style="display: none">
	<t:formvalid formid="formobj" layout="div" dialog="true"
		action="organzationController.do?doAddUserToOrg&orgId=${orgId}"
