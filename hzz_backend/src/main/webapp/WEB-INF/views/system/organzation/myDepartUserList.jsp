		...
		<div data-options="region:'center'">
			<t:datagrid name="departUserList" title="common.operation"
				...
				<t:dgCol title="common.department" sortable="false"
					field="userOrgList.tsDepart.departname" query="false" width="60"></t:dgCol>
				<t:dgCol title="common.position.name" sortable="false"
					field="positionName" query="false" width="30"></t:dgCol>
				...
				<t:dgFunOpt funname="openAuthorizeSet(id)" title="分配部门角色"
					...
					urlStyle="background-color:#18a689;"></t:dgFunOpt>
			</t:datagrid>
		</div>
	</div>
