...
<t:datagrid name="departUserList" title="common.operation"
	...
	<t:dgCol title="common.username" sortable="false" width="300"
		field="userName" query="true"></t:dgCol>
	<t:dgCol title="common.real.name" field="realName" width="300"
		query="true"></t:dgCol>
	<t:dgCol title="common.status" sortable="true" width="300"
		field="status"
	...
	<t:dgToolBar title="common.add.exist.user" icon="icon-add"
		url="organzationController.do?goAddUserToOrg&orgId=${departid}"
