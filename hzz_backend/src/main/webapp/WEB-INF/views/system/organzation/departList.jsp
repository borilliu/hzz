...
<div id="main_depart_list" class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="departList" title="common.department.list"
			fitColumns="true" actionUrl="organzationController.do?departgrid"
			...
			<t:dgDelOpt url="organzationController.do?del&id={id}"
		...
		<div id="departListtb" style="padding: 3px; height: 25px">
			<div style="float: left;">
				<a href="#" class="easyui-linkbutton" plain="true" icon="icon-add"
					...
					onclick="update('<t:mutiLang langKey="common.edit.param" langArg="common.department"/>','organzationController.do?update','departList','680px','450px')"><t:mutiLang
