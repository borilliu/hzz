...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tSDictTableConfigList" checkbox="false"
			pagination="true" fitColumns="true" title="字典表授权配置"
			sortName="createDate"
			actionUrl="tSDictTableConfigController.do?datagrid" idField="id"
			fit="true" queryMode="group">
			<t:dgCol title="主键" field="id" hidden="true" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="表名" field="tableName" query="true" queryMode="single"
				width="120"></t:dgCol>
			...
			<t:dgCol title="是否启用" field="isvalid" queryMode="single"
				dictionary="sf_yn" width="120"></t:dgCol>
			...
			<t:dgDelOpt title="删除"
				url="tSDictTableConfigController.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="tSDictTableConfigController.do?goAdd" funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="tSDictTableConfigController.do?goUpdate" funname="update"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove"
				url="tSDictTableConfigController.do?doBatchDel"
				funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search"
				url="tSDictTableConfigController.do?goUpdate" funname="detail"></t:dgToolBar>
		</t:datagrid>
	</div>
</div>
