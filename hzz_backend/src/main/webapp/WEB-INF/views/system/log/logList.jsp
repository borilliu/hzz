...
<t:datagrid title="log.manage" name="logList"
	...
	<t:dgCol title="日志类型" field="operatetype"
		replace="登录_1,退出_2,插入_3,删除_4,更新_5,上传_6,其他_7"></t:dgCol>
	...
	<t:dgCol title="(推荐使用IE8+,<br>谷歌浏览器可以获得更快,<br>更安全的页面响应速度) "
		field="broswer" width="100"></t:dgCol>
...
<div id="logListtb" style="padding: 3px; height: 25px">
	<span style="float: left;"> <a href="#"
		...
		icon="icon-search"
		onclick="detail('<t:mutiLang langKey="common.view"/>','logController.do?logDetail','logList',680,450)"
	...
	<div style="float: right; padding-right: 15px;">
		日志类型: <select name="operatetype" id="operatetype"
			...
			style="width: 140px; margin-right: 20px;" class="Wdate"
