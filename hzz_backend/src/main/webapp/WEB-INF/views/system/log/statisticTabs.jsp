...
<t:tabs id="tt" iframe="false">
	<t:tab href="logController.do?userBroswer&reportType=line"
		icon="fa fa-line-chart" title="user.analysis.line" id="pnode"></t:tab>
	<t:tab href="logController.do?userBroswer&reportType=pie"
		icon="fa fa-pie-chart" title="user.analysis.pie" id="pnode"></t:tab>
	<t:tab href="logController.do?userBroswer&reportType=column"
		icon="fa fa-bar-chart" title="user.analysis.histogram" id="pnode"></t:tab>
</t:tabs>
<script type="text/javascript">
