...
<t:datagrid name="interroleUserList" title="common.operation"
	actionUrl="interroleController.do?roleUserDatagrid&roleId=${roleId}"
	...
	<t:dgDelOpt title="取消关联"
		url="interroleController.do?delUserRole&userid={id}&roleid=${roleId }"
		urlclass="ace_button" urlfont="fa-trash-o" />
	<t:dgToolBar title="common.add.param" langArg="common.user"
		icon="icon-add"
		url="userController.do?addorupdateInterfaceUser&roleId=${roleId}"
		funname="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user"
		icon="icon-edit"
		url="userController.do?addorupdateInterfaceUser&roleId=${roleId}"
		funname="update"></t:dgToolBar>
	<t:dgToolBar title="关联用户" icon="icon-add"
		url="interroleController.do?goAddUserToRole&roleId=${roleId}"
		funname="add" width="580"></t:dgToolBar>
</t:datagrid>
