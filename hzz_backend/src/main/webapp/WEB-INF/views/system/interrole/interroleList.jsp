...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="roleList" title="接口角色列表"
			actionUrl="interroleController.do?roleGrid" fitColumns="true"
			idField="id" sortName="id" sortOrder="desc" queryMode="group">
			...
			<t:dgToolBar title="接口角色录入" langArg="common.role" icon="icon-add"
				url="interroleController.do?addorupdate" funname="add"></t:dgToolBar>
			<t:dgToolBar title="接口角色编辑" langArg="common.role" icon="icon-edit"
				url="interroleController.do?addorupdate" funname="update"></t:dgToolBar>
...
<div region="east" style="width: 600px;" split="true">
	<div tools="#tt" class="easyui-panel"
		title='<t:mutiLang langKey="接口权限设置"/>' style="padding: 10px;"
