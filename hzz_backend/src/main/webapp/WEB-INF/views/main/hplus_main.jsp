					...
					<div class="navbar-header" style="height: 60px;">
						...
						<form role="search" class="navbar-form-custom" method="post"
							...
							<div class="form-group">
								<input type="text" placeholder="欢迎使用平台 …" class="form-control"
					...
					<ul class="nav navbar-top-links navbar-right">
						<li class="dropdown" onfocus="bindFrameClick()"><a
							...
							<ul class="dropdown-menu dropdown-alerts">
								...
								<li><a
									href="javascript:add('<t:mutiLang langKey="common.change.style"/>','userController.do?changestyle','',550,270)"><t:mutiLang
