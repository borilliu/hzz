...
.dropdown-menu li a:hover, .dropdown-menu li a:focus, .dropdown-menu li a:active,
	...
	.dropdown-menu .dropdown-submenu:hover>a, .nav-tabs .dropdown-menu li>a:focus
	{
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <i
						class="icon-leaf"></i> <t:mutiLang langKey="jeect.platform" />
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a
								href="javascript:add('<t:mutiLang langKey="common.change.style"/>','userController.do?changestyle','',550,270)">
