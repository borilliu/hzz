...
<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet"
	href="${webRoot}/plug-in/themes/adminlte/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet"
	href="${webRoot}/plug-in/themes/adminlte/css/font-awesome.min.css">
<!-- Ionicons -->
<link rel="stylesheet"
	href="${webRoot}/plug-in/themes/adminlte/css/ionicons.min.css">
<!-- Theme style -->
<link rel="stylesheet" href="${webRoot}/plug-in/themes/adminlte/css/AdminLTE.css">
<!-- AdminLTE Skins -->
<link rel="stylesheet"
	href="${webRoot}/plug-in/themes/adminlte/css/_all-skins.min.css">
...
<body class="hold-transition skin-blue sidebar-mini fixed"
	...
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="#" class="logo"> <span class="logo-mini">赛立</span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><img alt="image" width="190"
					height="68" style="margin: -9px 0px 0px -16px;"
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown notifications-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <i
								class="fa fa-cog fa-fw"></i> <span class="label label-warning">5</span>
						</a>
							<ul class="dropdown-menu">
								<li>
									...
									<ul class="menu">
										<li><a
											href="javascript:createdetailwindow('<t:mutiLang langKey="common.ssms.getSysInfos"/>','tSSmsController.do?goMySmsList',800,400)"
											title="系统消息"> <i class="fa fa-users text-aqua"></i> 系统消息
										</a></li>
										<li><a href="javascript:clearLocalstorage()"> <i
												class="fa fa-users text-red"></i> <t:mutiLang
													langKey="common.clear.localstorage" />
										</a></li>
										<li><a
											href="javascript:add('首页风格','userController.do?changestyle','',550,270)"
											title="换肤"> <i class="fa fa-shopping-cart text-green"></i>风格切换
										</a></li>
									</ul>
								</li>
							</ul></li>
						...
						<li class="dropdown messages-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="footer"><a href="javascript:goAllMessage();"
									id="messageFooter"> 查看所有消息 <i class="icon-arrow-right"></i>
								</a></li>
							</ul></li>
						...
						<li class="dropdown notifications-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="footer"><a href="javascript:goAllNotice();"
									id="noticeFooter"> 查看全部 <i class="icon-arrow-right"></i>
								</a></li>
							</ul></li>
                ...
                <a href="#">View all tasks</a>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="plug-in/themes/fineui/common/image/head.jpg"
								class="user-image" alt="User Image"> <span
								class="hidden-xs">${userName}</span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header" style="height: 175px;"><img
									src="plug-in/themes/fineui/common/image/head.jpg"
									class="img-circle" alt="User Image">
									<p style="color: #ffffff; font-size: 14px">
										<span><t:mutiLang langKey="common.user" />:</span> <span>${userName }</span><br />
										<span><t:mutiLang langKey="current.org" />:</span> <span>${currentOrgName }</span><br />
										<span><t:mutiLang langKey="common.role" />:</span> <span>${roleName }</span>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
									<div class="row">
										<div class="col-xs-4 text-center">
											<a
												href="javascript:openwindow('个人信息','userController.do?userinfo')">个人信息</a>
										</div>
										<div class="col-xs-4 text-center">
											<a
												href="javascript:add('<t:mutiLang langKey="common.change.password"/>','userController.do?changepassword','',550,200)">修改密码</a>
										</div>
										<div class="col-xs-4 text-center">
		...
		<footer class="main-footer">
			<div class="pull-right hidden-xs">
				<a href="http://www.jssaili.com/" title="江苏赛立" target="_blank">江苏赛立
				</a> <b>技术支持<b>
			</div>
			<a href="http://www.jssaili.com/" title="江苏赛立" target="_blank">江苏赛立
			</a> <b>版权所有</b> (推荐谷歌浏览器，获得更快响应速度)
		...
		<aside id="control-sidebar"
			class="control-sidebar control-sidebar-dark"></aside>
		<!-- /.control-sidebar -->
  ...
  $.widget.bridge('uibutton', $.ui.button);
	...
	<link rel="stylesheet" href="plug-in/viewer/viewer.css" type="text/css"></link>
	<script type="text/javascript" src="plug-in/viewer/viewer.js"></script>
	<script>
