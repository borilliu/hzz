...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<!-- 顶部-->
	<div region="north" border="false" title="江苏赛立"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" style="vertical-align: text-bottom;"><img
					src="plug-in/login/images/head.png;"> <!-- <img src="plug-in/login/images/foot.png"> -->
				</td>
					...
					<table>
						...
						<tr>
							...
							<div id="layout_north_kzmbMenu"
								...
								<div class="menu-sep"></div>
								<div
									onclick="createdetailwindow('<t:mutiLang langKey="common.ssms.getSysInfos"/>','tSSmsController.do?goMySmsList',800,400)">
									<t:mutiLang langKey="common.ssms.getSysInfos" />
								</div>
								<div class="menu-sep"></div>
								<div
									onclick="add('<t:mutiLang langKey="common.change.style"/>','userController.do?changestyle','',550,250)">
...
.proccess b {
	...
	background: url(plug-in/layer/skin/default/loading-2.gif) no-repeat 0
		center;
	padding-left: 55px;
