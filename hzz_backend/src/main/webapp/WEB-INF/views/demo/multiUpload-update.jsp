...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="multiUploadController.do?doUpdate"
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value">
					...
					<table id="test_file_1_fileTable"></table> <span
			...
			<tr>
				...
				<td class="value">
					...
					<table id="test_file_2_fileTable"></table> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value">
					...
					<table id="test_file_3_fileTable"></table> <span
					class="Validform_checktip"></span> <label class="Validform_label"
