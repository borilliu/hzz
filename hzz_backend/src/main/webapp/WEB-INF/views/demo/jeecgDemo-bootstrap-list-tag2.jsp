...
<body>
	...
	<t:datagrid name="jeecgDemoList" checkbox="true" query="true"
		component="bootstrap-table" sortName="birthday,name" pagination="true"
		fitColumns="false" title="jeecg_demo" superQuery="true"
		...
		<t:dgCol title="id" field="id" hidden="true" queryMode="group"
			width="120"></t:dgCol>
		<t:dgCol title="名称" field="name" query="true" showLen="10"
		...
		<t:dgCol title="年龄" extend="{style:'width:50px'}" editor="numberbox"
			field="age" queryMode="group" query="true" width="120"></t:dgCol>
		...
		<t:dgCol title="性别" field="sex" query="true" showMode="radio"
			replace="女_1,男_0" dictionary="sex" width="120"
			extendParams="styler:fmtype"></t:dgCol>
		<t:dgCol title="电话" field="phone" queryMode="group" width="120"></t:dgCol>
		<t:dgCol title="工资" field="salary" query="true" queryMode="group"
			width="120"></t:dgCol>
		<t:dgCol title="创建日期" field="createDate" formatter="yyyy-MM-dd"
			query="true" queryMode="group" editor="datebox" width="120"></t:dgCol>
		<t:dgCol title="邮箱" field="email" query="true" popup="true"
			dictionary="user_msg,email,realname" width="120"></t:dgCol>
		<t:dgCol title="入职状态" field="status" query="true"
			extend="{style:{width:'300px';color:'red'};datatype:'*';}"
			defaultVal='N' dictionary="t_s_base_user,username,realname"
			width="80"></t:dgCol>
		...
		<t:dgDelOpt title="删除" url="jeecgListDemoController.do?doDel&id={id}"
			urlclass="btn btn-danger btn-xs" urlfont="fa-trash-o" />
		<t:dgToolBar title="录入" icon="icon-add"
			url="jeecgListDemoController.do?goBootStrapTableAdd2" funname="add"
			width="750" height="500"></t:dgToolBar>
		<t:dgToolBar title="编辑" icon="icon-edit"
			url="jeecgListDemoController.do?goBootStrapTableUpdate2"
			funname="update" width="750" height="500"></t:dgToolBar>
		<t:dgToolBar title="批量删除" icon="icon-remove"
			url="jeecgListDemoController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
	</t:datagrid>
</body>
</html>