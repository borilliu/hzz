...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgMysearchList" pageSize="500" checkbox="true"
			pagination="true" fitColumns="false" title="自定义列表查询条件"
		...
		<div id="jeecgMysearchListtb" style="padding: 3px; height: 25px">
			...
			<div align="right" class="searchColums">
				<label for="name" class="col-sm-2 control-label">名字: </label><input
					class="form-control" type="text" name="name" placeholder="请输入名字" />
				<label for="age" class="col-sm-2 control-label">年龄： </label><input
					class="form-control" type="text" name="age" placeholder="请输入年龄" />
				<label for="sex" class="col-sm-2 control-label">性别： </label> <select
