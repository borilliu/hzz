...
<t:base
	type="jquery,aceform,DatePicker,validform,ueditor,uploadify,layer"></t:base>
</head>
<body>
	<form id="formobj" action="jeecgListDemoController.do?doUpdate"
		...
		<input type="hidden" id="btn_sub" class="btn_sub" /> <input
			type="hidden" id="id" name="id" value="${jeecgDemoPage.id}" />
		<div class="tab-wrapper">
			<!-- tab -->
			<ul class="nav nav-tabs">
				<li role="presentation" class="active"><a
					href="javascript:void(0);">ace新增demo</a></li>
			</ul>
			<!-- tab内容 -->
					...
					<div class="row show-grid">
						...
						<div class="col-xs-6">
							<input id="name" name="name" type="text" class="form-control"
								datatype="s2-50" value="${jeecgDemoPage.name}" /> <span
					...
					<div class="row show-grid">
						...
						<div class="col-xs-6">
							<input id="age" name="age" type="text" class="form-control"
								ignore="ignore" datatype="n" value="${jeecgDemoPage.age}" /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-6">
							<select name="sex" class="form-control" style="width: 164px"
								...
								<option value=""></option>
								<option value="0"
									<c:if test="${jeecgDemoPage.sex==0}">selected</c:if>>男
								</option>
								<option value="1"
									<c:if test="${jeecgDemoPage.sex==1}">selected</c:if>>女
								</option>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-6">
							<input id="salary" name="salary" type="text" class="form-control"
								ignore="ignore" value="${jeecgDemoPage.salary}" /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
