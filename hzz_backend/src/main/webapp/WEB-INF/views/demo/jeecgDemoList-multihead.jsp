...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgDemoList" checkbox="true"
			sortName="birthday,name" pagination="true" fitColumns="true"
			title="多表头列表 Demo" actionUrl="jeecgListDemoController.do?datagrid"
			...
			<t:dgCol title="入职状态" field="status" rowspan="2" defaultVal='N'
				dictionary="sf_yn" width="80"></t:dgCol>
			<t:dgCol title="创建日期" field="createDate" rowspan="2"
				formatter="yyyy-MM-dd" queryMode="group" editor="datebox"
				width="120"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="150" newColumn="true"
				rowspan="2"></t:dgCol>
			...
			<t:dgCol title="部门" field="depId" queryMode="single"
