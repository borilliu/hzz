...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgMinidaoList" checkbox="true" pagination="true"
			fitColumns="false" title="用户Demo列表，采用minidao查询数据"
			...
			<t:dgToolBar title="批量插入用户DEMO" icon="icon-add"
				url="jeecgListDemoController.do?jdbcBatchSave"
				funname="toController"></t:dgToolBar>
			<t:dgToolBar title="调用存储批量删除用户DEMO" icon="icon-add"
				url="jeecgListDemoController.do?jdbcProcedure"
				funname="toController"></t:dgToolBar>
