...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jformOrderCustomer2List" filterBtn="true"
			onDblClick="datagridDbclick" checkbox="true" pagination="true"
			fitColumns="true" title=""
			actionUrl="jformOrderCustomer2Controller.do?datagrid" idField="id"
			fit="true" queryMode="group">
			<t:dgCol title="主键" field="id" extendParams="editor:'text'"
				hidden="true" queryMode="single" width="120"></t:dgCol>
			<t:dgCol title="客户名" field="name" extendParams="editor:'text'"
				queryMode="single" width="120"></t:dgCol>
			<t:dgCol title="单价" field="money" filterType="numberbox"
			...
			<t:dgCol title="性别" field="sex" extendParams="editor:'combobox'"
				filterType="combobox" queryMode="single" dictionary="sex"
				width="120"></t:dgCol>
			<t:dgCol title="电话" field="telphone"
				extendParams="editor:{type:'validatebox',options:{validType:'phoneRex'}}"
				queryMode="single" width="120"></t:dgCol>
			<t:dgCol title="外键" field="fkId" extendParams="editor:'text'"
				hidden="true" queryMode="single" width="120"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="100"></t:dgCol>
			<t:dgDelOpt title="删除"
				url="jformOrderCustomer2Controller.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgFunOpt funname="curd.addRow" title="新增一行" urlclass="ace_button"
				urlfont="fa-plus"></t:dgFunOpt>
		</t:datagrid>
	</div>
