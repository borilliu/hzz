...
<style>
.tab-wrapper .nav-tabs>li.active>a, .tab-wrapper .nav-tabs>li.active>a:hover,
...
<body>
	<form id="formobj"
		action="jformOrderMain2Controller.do?${empty mainId?'doAdd':'doUpdate'}"
		name="formobj" method="post">
		<input type="hidden" id="btn_sub" class="btn_sub" /> <input name="id"
			type="hidden" value="${mainId}">
		...
		<div id="jform_tab" class="tab-wrapper">
			...
			<ul class="nav nav-tabs">
				<li role="presentation"
					tab-ajax-url="jformOrderMain2Controller.do?mainPage&id=${mainId}&load=${load}">
					<a href="#con-wrapper0">订单主信息</a>
				</li>
				<li role="presentation"
					tab-ajax-url="jformOrderMain2Controller.do?jformOrderTicket2List&id=${mainId}">
					<a href="#con-wrapper1">订单机票信息</a>
				</li>
				<li role="presentation"
					tab-ajax-url="jformOrderMain2Controller.do?jformOrderCustomer2List&id=${mainId}">
  ...
  function neibuClick() {
	  ...
	  $('#btn_sub').trigger('click');
		...
		<div align="center" id="sub_tr" style="display: none;">
			<input type="button" value="提交" onclick="neibuClick();"
	...
	<table style="display: none">
		<tbody id="add_jformOrderTicket2_table_template">
			<tr>
				...
				<td align="left"><input
					name="jformOrderTicket2List[#index#].ticketCode" maxlength="100"
					datatype="*" ignore="checked" type="text" class="form-control"
					style="width: 120px;" /></td>
				<td align="left"><input
					name="jformOrderTicket2List[#index#].tickectDate" maxlength="10"
					type="text" class="form-control"
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
					style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent; width: 120px;"
					datatype="*" ignore="checked" /></td>
			</tr>
		</tbody>
		<tbody id="add_jformOrderCustomer2_table_template">
			<tr>
				...
				<td scope="row"><div name="xh"></div></td>
				<td align="left"><input
					name="jformOrderCustomer2List[#index#].name" maxlength="32"
					ignore="ignore" type="text" class="form-control"
					style="width: 120px;" /></td>
				<td align="left"><input
					name="jformOrderCustomer2List[#index#].money" maxlength="10"
					datatype="/^(-?\d+)(\.\d+)?$/" ignore="ignore" type="text"
					class="form-control" style="width: 120px;" /></td>
				<td align="left"><t:dictSelect
						field="jformOrderCustomer2List[#index#].sex" type="list"
						extendJson="{class:'form-control',style:'width:150px'}"
						typeGroupCode="sex" defaultVal="" hasLabel="false" title="性别"></t:dictSelect>
				</td>
				<td align="left"><input
					name="jformOrderCustomer2List[#index#].telphone" maxlength="32"
					ignore="ignore" type="text" class="form-control"
					style="width: 120px;" /></td>
			</tr>
		</tbody>
