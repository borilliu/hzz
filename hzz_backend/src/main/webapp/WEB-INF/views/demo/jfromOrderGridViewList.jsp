...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jfromOrderList" checkbox="true" fitColumns="true"
			title="订单列表"
			extendParams="view: detailview,detailFormatter:detailFormatterFun,onExpandRow: onExpandRowFun"
			actionUrl="jfromOrderController.do?datagrid" idField="id" fit="true"
			queryMode="group">
