...
<link href="plug-in/hplus/css/plugins/chosen/chosen.css"
	rel="stylesheet">
...
<body>
	<div class="container">
		<div class="row" style="margin-top: 10px">
			<select data-placeholder="选择省份..." class="chosen-select1"
		...
		<div class="row" style="margin-top: 10px">
			<select data-placeholder="选择省份" class="chosen-select2" multiple
		...
		<div class="row" style="margin-top: 20px">
			<button id="getval" type="button" class="btn btn-success">点击获取控件值</button>
		</div>
	</div>
	<script type="text/javascript">
$(function(){
	/*// 动态加载下拉列表
	$('.chosen-select2').bind("chosen:ready", function () {
		debugger
		$(".chosen-select2").append('<option value="110000">北京</option>');
		...
		<table class="optionsTb">
			...
			<tbody>
				<tr>
					...
					<td>false</td>
					<td>设置为 true 时非必选的单选框会显示清除选中项图标</td>
				</tr>
				<tr>
					<td>disable_search</td>
					<td>false</td>
					<td>设置为 true 隐藏单选框的搜索框</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>false</td>
					<td>是否继承 select 元素的 class，如果设为 true，Chosen 将把 select 的 class
						添加到容器上</td>
				</tr>
				<tr>
					<td>max_selected_options</td>
					<td>Infinity</td>
					<td>最多选择项数，达到最大限制时会触发 chosen:maxselected 事件</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>true</td>
					<td>多选框中使用退格键删除选中项目，如果设为 false，第一次按 delete/backspace
						会高亮最好一个选中项目，再按会删除该项</td>
				</tr>
				<tr>
 ...
 $('.chosen-select').chosen({
  ...
  width: '95%'
		...
		<div style="font-size: 14px; margin-top: 10px">
			可以通过在select 上设置属性传递给 Chosen.<br> <b>注意： 改属性会覆盖
				placeholder_text_multiple 或 placeholder_text_single 选项。</b>
		</div>
		...
		<table class="optionsTb">
			...
			<tbody>
				<tr>
					<td>change</td>
					<td>Chosen 触发标准的 change 事件，同时会传递 selected or deselected 参数，
						方便用户获取改变的选项</td>
				</tr>
				<tr>
					<td>chosen:ready</td>
				...
				<tr>
					...
					<td>超过 max_selected_options 设置时触发</td>
				</tr>
				<tr>
 ...
 **注意：**所有 Chosen 自定义事件 都包含 Chosen 实例 chosen 对象作为参数。
		...
		<a
			href="https://harvesthq.github.io/chosen/#hide-search-on-single-select"
			target="view_window">插件官方示例</a>
