...
body {
	...
	color: #333;
	font: 12px/1.5 "Microsoft YaHei", "Helvetica Neue", Helvetica, STHeiTi,
		sans-serif;
...
.icon_photo {
	background:
		url("plug-in/plupload/jquery.ui.plupload/img/icon_photo.png")
		no-repeat scroll 0 0;
	width: 20px;
	height: 15px;
}

.emot_photo_video .item {
	vertical-align: top;
	display: inline-block;
	margin: 0 10px 0 0
}

.emot_photo_video .item i, .emot_photo_video .item span {
...
.pic_close {
	background: url("plug-in/plupload/jquery.ui.plupload/img/ico_layer.png")
		no-repeat scroll -25px -25px;
	display: none;
	height: 20px;
	width: 20px;
	position: absolute;
...
.photo_upload_close {
	background:
		url("plug-in/plupload/jquery.ui.plupload/img/local_upload_close.png")
		no-repeat scroll 0 0;
	display: block;
	height: 11px;
	width: 11px;
...
.uploadify-button {
	...
	background-image: -webkit-gradient(linear, 0% 100%, 0% 0%, from(rgb(80, 80, 80)),
		to(rgb(112, 112, 112)));
...
<body>
	...
	<div class="demo clearfix" style="padding-bottom: 200px">
		<div class="emot_photo_video" style="position: relative;">
			<div id="btn" class="uploadify-button"
				style="position: relative; cursor: pointer; height: 18px; line-height: 18px; width: 80px;">
				<span class="uploadify-button-text">选择图片</span>
			</div>

			<div id="container" class="moxie-shim moxie-shim-html5"
				style="position: absolute; top: 0px; left: 0px; width: 48px; height: 18px; overflow: hidden; z-index: 0;">
				<input id="html5fileupload" type="file"
