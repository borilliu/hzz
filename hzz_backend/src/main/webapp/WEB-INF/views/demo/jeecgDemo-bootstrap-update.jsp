			...
			<div class="col-sm-7">
				<div class="input-group" style="width: 100%">
					<span class="input-group-btn">
						...
						<option value="402880e447e9a9570147e9b677320003"
							<c:if test="${jeecgDemoPage.depId=='402880e447e9a9570147e9b677320003'}"> selected </c:if>>软件信息部</option>
						<option value="402880e447e9a9570147e9b6a3be0005"
							<c:if test="${jeecgDemoPage.depId=='402880e447e9a9570147e9b6a3be0005'}"> selected </c:if>>销售部门</option>
						<option value="402880e447e9a9570147e9b710d20007"
							<c:if test="${jeecgDemoPage.depId=='402880e447e9a9570147e9b710d20007'}"> selected </c:if>>人力资源部</option>
						<option value="402880e447e9a9570147e9b762e30009"
							<c:if test="${jeecgDemoPage.depId=='402880e447e9a9570147e9b762e30009'}"> selected </c:if>>销售经理</option>
						<option value="402880e447e9ba550147e9c53b2e0013"
							<c:if test="${jeecgDemoPage.depId=='402880e447e9ba550147e9c53b2e0013'}"> selected </c:if>>财务</option>
						<option value="402880e6487e661a01487e6b504e0001"
							<c:if test="${jeecgDemoPage.depId=='402880e6487e661a01487e6b504e0001'}"> selected </c:if>>销售人员</option>
						<option value="402880f15986303c0159864816180002"
							<c:if test="${jeecgDemoPage.depId=='402880f15986303c0159864816180002'}"> selected </c:if>>部门经理</option>
						<option value="8a8ab0b246dc81120146dc8180a20016"
							<c:if test="${jeecgDemoPage.depId=='8a8ab0b246dc81120146dc8180a20016'}"> selected </c:if>>中国人寿总公司</option>
						<option value="8a8ab0b246dc81120146dc8180ba0017"
							<c:if test="${jeecgDemoPage.depId=='8a8ab0b246dc81120146dc8180ba0017'}"> selected </c:if>>JEECG开源社区</option>
						<option value="8a8ab0b246dc81120146dc8180bd0018"
							<c:if test="${jeecgDemoPage.depId=='8a8ab0b246dc81120146dc8180bd0018'}"> selected </c:if>>软件开发部</option>
					</select>
				</div>
			</div>
		</div>
