...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jfromOrderList" checkbox="true" fitColumns="true"
			complexSuperQuery="jfrom_order" title="订单列表"
			actionUrl="jfromOrderController.do?datagrid" isShowSubGrid="true"
			configId="jfrom_order" idField="id" fit="true" queryMode="group">
			...
			<t:dgCol title="收货人" field="receiverName" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="联系电话" field="receiverMobile" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="收货省" field="receiverState" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="收货市" field="receiverCity" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="收货区" field="receiverDistrict" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="收货地址" field="receiverAddress" queryMode="single"
				width="210"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="100"></t:dgCol>
			<t:dgDelOpt title="删除" url="jfromOrderController.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="jfromOrderController.do?goAdd" funname="add" width="100%"
				height="100%"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="jfromOrderController.do?goUpdate" funname="update" width="100%"
				height="100%"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove"
				url="jfromOrderController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search"
				url="jfromOrderController.do?goUpdate" funname="detail" width="100%"
				height="100%"></t:dgToolBar>
...
<script src="views/com/jeecg/demo/jfromOrderList.js"></script>
