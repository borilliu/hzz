...
<body>
	<t:datagrid name="jeecgDemoList1" checkbox="true"
		component="bootstrap-table" sortName="createDate,name"
		pagination="true" fitColumns="false" title="jeecg_demo"
		superQuery="true" actionUrl="jeecgListDemoController.do?datagrid"
		idField="id" fit="true" queryMode="group" filter="true">
		...
		<t:dgCol title="性别" field="sex" query="true" showMode="radio"
			dictionary="sex" width="120" extendParams="styler:fmtype"></t:dgCol>
		...
		<t:dgCol title="邮箱" field="email" query="true" popup="true"
			dictionary="user_msg,name@email,account@realname" width="120"></t:dgCol>
		...
		<t:dgToolBar title="录入" icon="icon-add"
			url="jeecgListDemoController.do?goBootStrapTableAdd" funname="add"
			width="770" height="500"></t:dgToolBar>
		<t:dgToolBar title="编辑" icon="icon-edit"
			url="jeecgListDemoController.do?goBootStrapTableUpdate"
			funname="update" width="770"></t:dgToolBar>
