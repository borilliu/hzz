		...
		<table style="width: 90%;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="phone" name="phone" type="text"
					style="width: 150px" class="inputxt" datatype="m" ignore="ignore" />
					<span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><t:webUploader auto="true" name="fujian"
						fileNumLimit="3" datatype="*"></t:webUploader> <span
				...
				<tr>
					...
					<td class="value"><script type="text/javascript"
						...
						<script type="text/javascript" charset="utf-8"
							...
							name="content" id="content" style="width: 100%; height: 300px"></textarea>
