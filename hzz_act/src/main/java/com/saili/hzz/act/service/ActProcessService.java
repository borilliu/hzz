...
import com.saili.hzz.act.vo.ActProcessVo;
...
public class ActProcessService {
	 ...
	 * 日志对象
	 */
	protected Logger logger = LoggerFactory.getLogger(ActProcessService.class);
	 ...
	 * 流程定义列表
	 */
	public DataGrid processList(DataGrid dataGrid, String category) {
		...
		dataGrid.setTotal(new Long(processDefinitionQuery.count()).intValue());
		dataGrid.setResults(new ArrayList());
	    List<ProcessDefinition> processDefinitionList = processDefinitionQuery.listPage(dataGrid.getFirstResult(), dataGrid.getMaxResults());
	    for (ProcessDefinition processDefinition : processDefinitionList) {
	      String deploymentId = processDefinition.getDeploymentId();
	      Deployment deployment = repositoryService.createDeploymentQuery().deploymentId(deploymentId).singleResult();
	      dataGrid.getResults().add(new ActProcessVo(processDefinition.getId(), processDefinition, deployment));
	    }
	 ...
	 * 流程定义列表
	 */
	public DataGrid runningList(DataGrid dataGrid, String procInsId, String procDefKey) {
		...
		dataGrid.setTotal(new Long(processInstanceQuery.count()).intValue());
		dataGrid.setResults(processInstanceQuery.listPage(dataGrid.getFirstResult(), dataGrid.getMaxResults()));
		return dataGrid;
	}
